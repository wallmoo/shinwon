	...
	function checkDragAndDropAPI(){
		bSupportDragAndDropAPI = false; //파일 드래그 업로드 적용 안함
		/*try{
			if( !oNavigator.ie ){
    ...
    function html5Upload() {	
    	...
    	sUploadURL= baseUrl+'/upload/SmartEditorHtml5Upload.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : baseUrl+'/upload/SmartEditorUpload.do',	//샘플 URL입니다.
            sCallback : baseUrl+'/smartEditor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소

					...
					<div class="minW magazine-view">
						...
						<div class="body"><!-- body -->
							...
							<div class="detail"><!-- detail -->
								...
								<p><c:out value="${info.MGZ_MST_CTS }" escapeXml="false" /></p>
...
//			alert("goReqPage");
	...
	goProductKakaoStory = function(){
		var paramUrl = "<c:out value="${frontDomain}"/>/pc/themecategory/weddingConView.do?MGZ_MST_IDX=<c:out value="${commandMap.MGZ_MST_IDX }" />";

	    ...
	    <article id="container" class="container">
	        <div class="minW contents"><!-- contents S -->
	            ...
	            <dl class="loc">
	                ...
	                <dd><a href="javascript:void(0)"><span>쇼핑내역</span></a></dd>
	            ...
	            <div id="body"><!-- #body -->
	                ...
	                <!-- <ul class="ct tab-a item-2">tab-a
	                    <li class="active"><a href="javascript:;"><span>쇼핑몰 주문내역</span></a><span class="blind">현재위치</span></li>
	                    <li><a href="javascript:;"><span>오프라인 매장 주문내역</span></a></li>
	                </ul>// tab-a -->
	                ...
	                <div class="section-button ar mt20"><!-- section-button -->
	                    ...
	                    <a href="javascript:changeSearchDlvGbn('2');" id="searchDlvGbnBtn_2" class="btn_st0 ${commandMap.searchDlvGbn eq Code.CART_DLV_GBN_SERVICE_CD ? 'btn_rd' : 'btn_white' } small"><strong>클린킹 주문만 보기</strong></a>
	                </div><!-- // section-button --> --%>
	                </form>
...
$(function(){
    ...
    search = function() 
    {
        $searchForm.attr({"action":"<c:out value="${serverSslDomain}" />/pc/mypage/gestDeliveryList.do", "target":"_self", "method":"get"}).submit(); 
    };
    ...
    goPage = function (cPage) 
    {
        ...
        $frm.attr({"action":"<c:out value="${serverSslDomain}"/>/pc/mypage/gestDeliveryList.do", "target":"_self", "method":"get"}).submit();
    };

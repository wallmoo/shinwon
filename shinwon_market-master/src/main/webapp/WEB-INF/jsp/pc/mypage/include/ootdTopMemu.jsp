			...
			<div class="my_modify_top_wrap mb100">
				<div class="my_modify_top_wrap mt110">
					<div class="my_modify_top">
						...
						<div class="tab_wrap">
								<ul class="tab n2">
									<li class="on"><a href="#my_tab1" id="goPageOotdBtn">OOTD</a></li>
									<li><a href="#my_tab2" id="goPageShoppingBtn">My Shopping</a></li>
								</ul>
								...
								<div class="tab_cont" id="my_tab2">
									...
									<div class="q_link_wrap">
										<ul class="clearboth">
											<li><a href="<c:out value="${serverSslDomain}" />/pc/mypage/myShoppingList.do">주문/배송 조회</a></li>
											...
											<li><a href="<c:out value="${serverSslDomain }"/>/pc/mypage/myInfoPasswordForm.do?returnUrl=/pc/mypage/myInfoEditForm.do">회원정보 수정</a></li>

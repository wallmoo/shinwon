...
<%-- 각 화면 본문 시작 --%>
	<div id="inner"><!-- inner -->
		<div class="container breadcrumb-wrap"><!-- breadcrumb -->
            <div id="breadcrumb" class="wrap">
                <div class="holder">
                    <span>홈</span>
                    <span class="gt">&gt;</span>
                    <strong class="warning">이미지게시판 미리보기</strong>
                </div>
            </div>
        </div><!-- // breadcrumb -->
		...
		<div id="lnb"><!-- lnb -->
		    <ul class="reset">
		        <li class="active"><a href="javascript:;">이미지게시판 미리보기</a></li>
		    </ul>
		</div><!-- // lnb -->

		<div id="internal"><!-- internal -->
		
		<h3 class="title"><span>이미지게시판 미리보기</span></h3>
		        ...
		        <!-- 상단공지 -->
              	<c:if test="${not empty topList }">
	                <c:forEach var="row" items="${topList }" varStatus="i">
	               	<tr>
	                    <td class="num">상단</td>
	                    <td><img src="${cdnDomain}${row.THUMB_NM}" style="width:100px;height:100px;padding:10px;"></td>
		...
		<input type="hidden" name="BRD_MST_TYPE" value="I"/>

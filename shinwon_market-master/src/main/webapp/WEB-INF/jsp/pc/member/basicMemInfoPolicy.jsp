		...
		<article id="container" class="container">
			<div class="minW contents"><!-- contents S -->
	            ...
	            <ul class="ct tab-a item-4"><!-- tab-a -->
	                <li class="active"><a href="javascript:;"><span>온라인 개인정보취급방침 (통합회원)</span></a><span class="blind">현재위치</span></li>
	            ...
	            <div class="access-terms"><!-- access-terms -->
	                ...
	                <p>
	                    마켓플랜트 쇼핑몰은 회원의 개인정보를 보호하기 위하여 「정보통신망 이용 촉진 및 정보보호 등에 관한 법률」 및 「개인정보보호법」 등 관련 법령상의 개인정보 보호 규정을 준수하고 있으며, 다음과 같이 개인정보 취급방침을 수립ㆍ공개합니다.<br/>

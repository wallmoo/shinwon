					...
					<table class="tb_row">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" id="MEM_MST_MEM_ID" name="MEM_MST_MEM_ID" value="" placeholder="아이디 입력" class="w602 " autocomplete="off"/>
							...
							<tr>
								...
								<td>
									...
									<span id="pw_txt_error" class=" txt_error" style="display: none;">비밀번호는 영문, 숫자, 특수문자 포함하여 8~15자를 입력해 주세요.</span>
							...
							<tr>
								...
								<td>
									<input type="password" id="MEM_MST_PW_RE" name="MEM_MST_PW_RE" placeholder="비밀번호 재입력" class="w602 "/> 
									<span id="pw2_txt_error" class=" txt_error" style="display: none;">비밀번호가 일치하지 않습니다.</span> 
							...
							<tr>
								<th scope="row">닉네임</th>
								<td>
									<input type="text" id="MEM_MST_NCK_NM" name="MEM_MST_NCK_NM" placeholder="닉네임 입력" class="w602"/>
									...
									<em class="txt_guide gray">특수문자제외 8~15자 입력<br>닉네임은 사이트 내 활동 시 아이디 대신 사용되며, 미입력시 아이디로 노출됩니다.</em><!-- 2019-12-17 수정 -->
								</td>
							</tr>
							<tr>
									...
									<span class="select">
										<select id="MEM_MST_HP1" name="MEM_MST_HP1" class="w284">
											...
											<c:forEach var="hp" items="${codes.HP_CODE}">
											   <option value="${hp.CMN_COM_NM }" <c:if test="${hp.CMN_COM_NM eq commandMap.MEM_MST_HP1}">selected="selcted"</c:if>>${hp.CMN_COM_NM}</option>
											</c:forEach>
										</select>
									</span>
									<span class="hyphen">-</span>
									<input id="MEM_MST_HP2" name="MEM_MST_HP2" type="number" name="" value="<c:out value="${commandMap.MEM_MST_HP2 }"/>" placeholder="번호 입력" class="w284"/>
									<span class="hyphen">-</span>
									<input id="MEM_MST_HP3" name="MEM_MST_HP3" type="number" name="" value="<c:out value="${commandMap.MEM_MST_HP3 }"/>" placeholder="번호 입력" class="w284"/>
								</td>
							</tr>
							<tr>
...
<script>
	...
	function validateEmail(){
		...
		if(emailRegExp.test($("#MEM_MST_MAIL_ID").val()+ "@" + $("#MEM_MST_MAIL_DOMAIN").val())){
			return true;

		...
		<div id="content" class="content">
            ...
            ***************************************************************************** -->
			...
			<form id="dataForm" name="dataForm" method="post">
                ...
                <input type="hidden" name="joinType" id="joinType" value="memberSns" />
...
<script>
	...
	$("#check-1").on("click",function(){
		...
		$('#check-2')[0].checked = flag;
		$('#check-3')[0].checked = flag;
	});
	
	$(".agree_list").change(function(){
		var serviceTerm = $('#check-2');
		var privacyTerm = $('#check-3');
        if(serviceTerm.is(":checked") && privacyTerm.is(":checked")){
        	$('#check-1')[0].checked = true;
        } else {
        	$('#check-1')[0].checked = false;
        }
    });

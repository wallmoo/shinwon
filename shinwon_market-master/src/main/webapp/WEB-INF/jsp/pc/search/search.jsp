...
<div id="container">
    <div id="content" class="content">
        ...
        <div class="sub_content product">
			...
			<div class="no_result_con no_search_result">
                <div class="no_result">
            ...
            <div class="search_product search_result" id="search_result">
                <div class="product_result">
                    <div class="items">
                        <p class="num">상품 (<span id="product_count">0</span>)</p>
                        <div class="select_box">
                            <span class="select">
                                <select class="order_select" data-type="product">
                                    <option value="ord_date" selected="selected">최근등록순</option>
                                    <option value="ord_lprice" >가격 낮은순</option>
                                    <option value="ord_hprice" >가격높은순</option>
                                    <option value="ord_scout" >판매량 많은순</option>
                                    <option value="ord_review">리뷰 많은순</option>
                                </select>
                            </span>
                        </div>
                    </div>
                    <div class="new_goods_wrap mt55">
                       <ul id="product_rst_list" class="new_goods_list clearboth">
                       </ul>
                    </div>
                </div>

                <div class="go_link_area">
                        <a data-type="product" href="javascipt:void(0);" class="search_more">더보기</a>
                </div>
                ...
                <div class="goods_list_wrap">
                        <div class="goods_sorting">
                            <div class="items">
                                <p class="num">타임세일 (<span id="time_count">0</span>)</p>
                                <div class="select_box">
                                    <span class="select">
		                               <select class="order_select" data-type="time">
		                                    <option value="ord_date" selected="selected">최근등록순</option>
		                                    <option value="ord_lprice" >가격 낮은순</option>
		                                    <option value="ord_hprice" >가격높은순</option>
		                                    <option value="ord_scout" >판매량 많은순</option>
                        ...
                        <!-- .new_goods_wrap -->
                        <div class="new_goods_wrap mt55">
                                <ul id="time_rst_list"  class="new_goods_list clearboth">
                                </ul>
                        </div>
                        <!-- // .new_goods_wrap -->
                </div>
                <!-- // .goods_list_wrap -->
                <div class="go_link_area">
   					<a data-type="time" href="javascipt:void(0);" class="search_more">더보기</a>
                </div>
                ...
                <div class="goods_list_wrap goods_funding">
                        <div class="goods_sorting">
                            <div class="items">
                                <p class="num">펀딩 (<span id="fund_count">0</span>)</p>
                                <div class="select_box">
                                    <span class="select">
		                               <select class="order_select" data-type="fund">
		                                    <option value="ord_date" selected="selected">최근등록순</option>
		                                    <option value="ord_lprice" >가격 낮은순</option>
		                                    <option value="ord_hprice" >가격높은순</option>
		                                    <option value="ord_scout" >판매량 많은순</option>
                        ...
                        <div class="new_goods_wrap">
                            <ul id="fund_rst_list"  class="new_goods_list clearboth">
                            </ul>
                        </div>
                        <!-- // .new_goods_wrap -->
                </div>
                <!-- // .goods_list_wrap -->
                <div class="go_link_area">
   					<a data-type="fund" href="javascipt:void(0);" class="search_more">더보기</a>
                </div>

                <div class="goods_exhibitions">
                    <div class="items">
                        <p class="num">기획전 (<span id="plan_count">0</span>)</p>
                    </div>
                    <div class="main-item list-box">
                        <div id="plan_rst_list" class="main-item-group">
                        </div>
                    </div>
                </div>
                ...
                <div class="goods_event">
                    <div class="items">
                        <p class="num">이벤트(<span id="event_count">0</span>)</p>
                    </div>
                    <div class="main-item list-box">
                        <div id="event_rst_list"  class="main-item-group">
                ...
                <div class="go_link_area">
   					<a data-type="event" href="javascipt:void(0);" class="search_more">더보기</a>
                </div>

                <!-- .mov_list_wrap -->
                <div class="mov_list_wrap channel_on">

                        <!-- .top_title_select_area cf -->
                        <div class="top_title_select_area clearboth">
                            <div class="items">
                                <p class="num">채널ON(<span id="haul_count">0</span>)</p>
                            </div>
                        </div>
                        <!-- // .top_title_select_area cf -->

                        <ul id="haul_rst_list" class="mov_list clearboth">
                        </ul>
                </div>
                <!-- // .mov_list_wrap -->
                <div class="go_link_area">
					<a data-type="haul" href="javascipt:void(0);" class="search_more">더보기</a>
                </div>
        </div>
        
        <!-- 검색결과없는경우 -->
        <div class="search_product search_result no_search_result">

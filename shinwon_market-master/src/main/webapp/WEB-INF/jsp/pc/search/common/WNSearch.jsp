		...
		*/
		...
		public String getPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
			...
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"nav prev\" href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+wnanchor.getBundleBefore()+"');\" title=\"이전페이지\"><span class=\"ir\">이전페이지</span></a>");
			} else {
				sbRet.append("<a class=\"nav prev\" href=\"javascript:void(0)\" title=\"이전페이지\"><span class=\"ir\">이전페이지</span></a>");
			} 
			...
			for(int i=0; i<pageCount && i < pages.length; i++) {
				if(pages[i][1].equals("-1")) {
					...
					sbRet.append("<a href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+pages[i][1]+"');\" title=\"페이징\"> "+pages[i][0]+" </a>");
				}
			}

			if(wnanchor.getBundleNext() != -1) {
    			sbRet.append("<a class=\"nav next\" href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+wnanchor.getBundleNext()+"')\" title=\"다음페이지\"><span class=\"ir\">다음페이지</span></a>");
			} else {
				sbRet.append("<a class=\"nav next\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"ir\">다음페이지</span></a>");
			}
			return sbRet.toString();
		}
		//테마페이징
		public String getThemaPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
			StringBuffer sbRet = new StringBuffer();
			WNAnchor wnanchor = getPageAnchor(startCount, totalCount, viewListCount, bundleCount);
			
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+wnanchor.getFirstPage()+"');\" title=\"이전페이지\"><span class=\"blind\">처음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_l\" href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+wnanchor.getBundleBefore()+"');\" title=\"이전페이지\"><span class=\"blind\">이전페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" title=\"처음페이지\"><span class=\"blind\">처음페이지</span></a>");
			...
			if(wnanchor.getBundleNext() != -1) {
    			sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+wnanchor.getBundleNext()+"')\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
    			sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" onClick=\"javascript:doPaging('"+wnanchor.getLastPage()+"')\" title=\"다음페이지\"><span class=\"blind\">마지막페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" title=\"마지막페이지\"><span class=\"blind\">마지막페이지</span></a>");
			}
		...
		public String getProductPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
			...
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" onClick=\"javascript:doProductPaging('"+wnanchor.getFirstPage()+"');\" title=\"이전페이지\"><span class=\"blind\">처음페이지</span></a>");
			...
			if(wnanchor.getBundleNext() != -1) {
    			...
    			sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" onClick=\"javascript:doProductPaging('"+wnanchor.getLastPage()+"')\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			}
...
// 			if(wnanchor.getFirstPage() != -1) {
// 				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" onClick=\"javascript:doEmagazinePaging('"+wnanchor.getFirstPage()+"');\" title=\"이전페이지\"><span class=\"blind\">처음페이지</span></a>");
...
//     			sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" onClick=\"javascript:doEmagazinePaging('"+wnanchor.getLastPage()+"')\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
// 			} else {
// 				sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
// 				sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
// 			}
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" onClick=\"javascript:doContents('ALL','"+wnanchor.getFirstPage()+"');\" title=\"처음페이지\"><span class=\"blind\">처음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_l\" href=\"javascript:void(0)\" onClick=\"javascript:doContents('ALL','"+wnanchor.getBundleBefore()+"');\" title=\"이전페이지\"><span class=\"blind\">이전페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" title=\"처음페이지\"><span class=\"blind\">처음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_l\" href=\"javascript:void(0)\" title=\"이전페이지\"><span class=\"blind\">이전페이지</span></a>");
			} 
			...
			for(int i=0; i<pageCount && i < pages.length; i++) {
				if(pages[i][1].equals("-1")) {
					...
					sbRet.append("<a href=\"javascript:void(0)\" onClick=\"javascript:doContents('ALL','"+(Integer.parseInt(pages[i][1])/viewListCount)+"');\" title=\"페이징\"> "+pages[i][0]+" </a>");
				}
			}

			if(wnanchor.getBundleNext() != -1) {
    			sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" onClick=\"javascript:doContents('ALL','"+wnanchor.getBundleNext()/16+"')\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
    			sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" onClick=\"javascript:doContents('ALL','"+wnanchor.getLastPage()/16+"')\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			}
		...
		public String getExhibitionsPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
			...
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" onClick=\"javascript:doExhibitionsPaging('"+wnanchor.getFirstPage()+"');\" title=\"이전페이지\"><span class=\"blind\">처음페이지</span></a>");
			...
			if(wnanchor.getBundleNext() != -1) {
    			...
    			sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" onClick=\"javascript:doExhibitionsPaging('"+wnanchor.getLastPage()+"')\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			}
		...
		public String getReviewPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
			...
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"ico_ar_first\" href=\"javascript:void(0)\" onClick=\"javascript:doReviewPaging('"+wnanchor.getFirstPage()+"');\" title=\"이전페이지\"><span class=\"blind\">처음페이지</span></a>");
			...
			if(wnanchor.getBundleNext() != -1) {
    			...
    			sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" onClick=\"javascript:doReviewPaging('"+wnanchor.getLastPage()+"')\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_r\" href=\"javascript:void(0)\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
				sbRet.append("<a class=\"ico_ar_last\" href=\"javascript:void(0)\" title=\"마지막 페이지\"><span class=\"blind\">마지막 페이지</span></a>");
			}

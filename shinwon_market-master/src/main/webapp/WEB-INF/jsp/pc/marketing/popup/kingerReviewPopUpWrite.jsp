...
<section id="wrap">	
	...
	<article id="container" class="container king_regist_pop">
		<div class="contents"><!-- .contents S -->
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="inp_box">
										<input type="text" name="EXP_REV_NM" id="EXP_REV_NM" maxlength="70"/>
										<span class="inp_num">(70자 이내)</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="inp_box">
										<input type="text" name="EXP_REV_SUB_NM" id="EXP_REV_SUB_NM" maxlength="50"/>
										<span class="tx_ex">※ 아래 내용의 요약글을 작성해주세요. 리스트에 노출됩니다.</span>
										<span class="inp_num">(50자 이내)</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="inp_box">
										<textarea name="EXP_REV_CTS" id="EXP_REV_CTS" style="width:90%;"></textarea>
							...
							<tr>
								...
								<td>
									<div class="inp_box">
										<input type="text" name="EXP_REV_URL" id="EXP_REV_URL" />
									</div>
								</td>
							</tr>
							<tr>
			...
			<div class="btn_box">
				<a href="#none" class="btn_bl" id="regist"><strong>리뷰 등록하기</strong></a>
			...
			<script type="text/javascript">
				$(document).on("click", "#regist", function(){
					...
					if (confirm("저장 하시겠습니까?")) {
						$("#frm").attr("action","<c:out value="${frontDomain}" />/pc/marketing/kingerReviewRegist.do").submit();
					}
				});

								...
								<tbody>
									...
									<tr>
										...
										<td class="td_comName">
											<div class="inp_box">
												<label for="">
													<input type="text" name="VDR_REQ_NM" id="VDR_REQ_NM" maxlength="40" value="<c:out value="${row.VDR_REQ_NM}" />"/>
												</label>
											</div>
										</td>
										...
										<td class="td_ceoName">
											<div class="inp_box">
												<label for="">
													<input type="text" name="VDR_REQ_CEO_NM" id="VDR_REQ_CEO_NM" maxlength="15" value="<c:out value="${row.VDR_REQ_CEO_NM}" />" />
												</label>
											</div>
										</td>
									</tr>
									<tr>
													...
													<select id="VDR_REQ_TYPE" name="VDR_REQ_TYPE" class="sel_chg">
						                                ...
						                                <c:if test="${not empty codes.BUSINESS_CODE }">
							                                <c:forEach var="mngTelRow" items="${codes.BUSINESS_CODE }" varStatus="i">
					                                    		...
					                                    		<c:if test="${mngTelRow.CMN_COM_IDX eq row.VDR_REQ_TYPE }">selected="selected"</c:if>>					                                    
										...
										<td class="td_regNum">
											<div class="inp_box">
												<label for="">
													<input type="text" name="VDR_REQ_JRD_NO1" id="VDR_REQ_JRD_NO1" maxlength="6" class="number"  value="<c:out value="${row.VDR_REQ_JRD_NO1 }" />" />
												</label>
												<span class="ico_tx">-</span>
												<label for="">
													<input type="text" name="VDR_REQ_JRD_NO2" id="VDR_REQ_JRD_NO2" maxlength="7" class="number" value="<c:out value="${row.VDR_REQ_JRD_NO2 }" />" />
												</label>
											</div>
										</td>
									</tr>
											...
											<div class="f inp_box">
												<label for="VDR_REQ_POST5">
													<input type="text" name="VDR_REQ_POST5" id="VDR_REQ_POST5" maxlength="5" 
														title="우편번호" readonly="readonly" data-err_msg_id="zip" value="<c:out value="${row.VDR_REQ_POST5 }"/>" />
												</label>
												<a href="javascript:void(0)" id="zipCheck" class="btn_gre"><span>우편번호 찾기</span></a>
											</div>
											<div class="inp_box">
												<label for="VDR_REQ_DR_ADDR1">
													<input type="text" name="VDR_REQ_DR_ADDR1" id="VDR_REQ_DR_ADDR1" placeholder="도로명 주소" maxlength="100" readonly="readonly" data-err_msg_id="doro1" value="<c:out value="${row.VDR_REQ_DR_ADDR1 }"/>" />
												</label>
												<label for="VDR_REQ_DR_ADDR2">
													<input type="text" name="VDR_REQ_DR_ADDR2" id="VDR_REQ_DR_ADDR2" placeholder="도로명 주소 상세" maxlength="100" data-err_msg_id="doro2" value="<c:out value="${row.VDR_REQ_DR_ADDR2 }"/>" />
												</label>
											</div>
											<div class="l inp_box">
												<label for="VDR_REQ_JB_ADDR1">
													<input type="text" name="VDR_REQ_JB_ADDR1" id="VDR_REQ_JB_ADDR1" placeholder="지번 주소" maxlength="100" readonly="readonly" data-err_msg_id="jibun" value="<c:out value="${row.VDR_REQ_JB_ADDR1 }"/>" />
												</label>
												<label for="VDR_REQ_JB_ADDR2">
													<input type="text" name="VDR_REQ_JB_ADDR2" id="VDR_REQ_JB_ADDR2" placeholder="지번 주소 상세" maxlength="100" data-err_msg_id="jibun" value="<c:out value="${row.VDR_REQ_JB_ADDR2 }"/>" />
												</label>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td colspan="3" class="td_email">
											<div class="inp_box">
												<c:set var="mail2" value="${fn:split(row.VDR_REQ_MAIL,'@')[1]}" />
												<label for="" class="blind">대표 email 아이디</label>
												<input type="text" name="VDR_REQ_MAIL_ID" id="VDR_REQ_MAIL_ID" maxlength="20" data-err_msg_id="memEmailId" value="<c:out value="${fn:split(row.VDR_REQ_MAIL,'@')[0] }"/>"/>
												<span class="ico_l">@</span>
												<label for="VDR_REQ_MAIL_DOMAIN" class="blind">대표 email 도메인</label>
												<input type="text" name="VDR_REQ_MAIL_DOMAIN" id="VDR_REQ_MAIL_DOMAIN" data-err_msg_id="memEmailDomain" value="<c:out value="${fn:split(row.VDR_REQ_MAIL,'@')[1] }"/>"/>
									...
									<tr>
										...
										<td colspan="3" class="td_busines">
											<div class="inp_box">
												<label for="">
													<input type="text" name="VDR_REQ_BUSI_CDT" id="VDR_REQ_BUSI_CDT"  value="<c:out value="${row.VDR_REQ_BUSI_CDT}"/>" />
												</label>
												<span class="ico_tx">/</span>
												<label for="">
													<input type="text" name="VDR_REQ_BUSI_TYPE" id="VDR_REQ_BUSI_TYPE" value="<c:out value="${row.VDR_REQ_BUSI_TYPE}"/>" />
												</label>
											</div>
										</td>
									</tr>
										...
										<td class="td_tel">
											<div class="inp_box">
						                                ...
						                                <c:if test="${not empty codes.TEL_CODE }">
							                                <c:forEach var="telRow" items="${codes.TEL_CODE }" varStatus="i">
							                                    <option value="<c:out value="${telRow.CMN_COM_NM }"/>" 
							                                    		<c:if test="${telRow.CMN_COM_NM eq row.VDR_REQ_TEL1 }">selected="selected"</c:if>>
												...
												<label for="VDR_REQ_TEL2">
													<input type="text" class="text small number" name="VDR_REQ_TEL2" id="VDR_CST_TEL2" maxlength="4" class="number" value="<c:out value="${row.VDR_REQ_TEL2}"/>" title="전화번호 중간자리" />
												</label>
												<span class="ico_tx">-</span>
												<label for="VDR_REQ_TEL3">
													<input type="text" class="text small number" name="VDR_REQ_TEL3" id="VDR_CST_TEL3" maxlength="4" class="number" value="<c:out value="${row.VDR_REQ_TEL3}"/>" title="전화번호 끝자리" />
												</label>
											</div>
										</td>
										...
										<td class="td_fax">
											<div class="inp_box">
												<label for="VDR_REQ_FAX1" class="">
													<select class="sel_chg" id="VDR_REQ_FAX1" name="VDR_REQ_FAX1" title="팩스 앞자리">
						                                ...
						                                <c:if test="${not empty codes.TEL_CODE }">
							                                <c:forEach var="telRow" items="${codes.TEL_CODE }" varStatus="i">
							                                    <option value="<c:out value="${telRow.CMN_COM_NM }"/>" 
							                                    		<c:if test="${telRow.CMN_COM_NM eq row.VDR_REQ_FAX1 }">selected="selected"</c:if>>
							                                    	<c:out value="${telRow.CMN_COM_NM }"/>
							                                    </option>
							                                </c:forEach>
						                                </c:if>
												...
												<label for="VDR_REQ_FAX2">
													<input type="text" class="text small number" name="VDR_REQ_FAX2" id="VDR_REQ_FAX2" maxlength="4" class="number" value="<c:out value="${row.VDR_REQ_FAX2}"/>" title="팩스 중간자리" />
												</label>
												<span class="ico_tx">-</span>
												<label for="VDR_REQ_FAX3">
													<input type="text" class="text small number" name="VDR_REQ_FAX3" id="VDR_REQ_FAX3" maxlength="4" class="number" value="<c:out value="${row.VDR_REQ_FAX3}"/>" title="팩스 끝자리" />
												</label>
											</div>
										</td>
									</tr>
						                                ...
						                                <c:if test="${not empty codes.KICC_BANK_CD }">
							                                <c:forEach var="bankRow" items="${codes.KICC_BANK_CD }" varStatus="i">
							                                    <option value="<c:out value="${bankRow.CMN_COM_ETC1 }"/>" 
							                                    		<c:if test="${bankRow.CMN_COM_ETC1 eq row.VDR_REQ_BANK_CD }">selected="selected"</c:if>>
										...
										<td class="td_accNum">
											<div class="inp_box">
												<label for="VDR_REQ_ACT_NO">
													<input type="text" name="VDR_REQ_ACT_NO" id="VDR_REQ_ACT_NO" class="number" value="<c:out value="${row.VDR_REQ_ACT_NO}"/>" maxlength="30" />
												</label>
											</div>
										</td>
									</tr>
										...
										<td colspan="3" class="td_accHolder">
											<div class="inp_box">
												<label for="VDR_REQ_ACT_HDR">
													<input type="text" name="VDR_REQ_ACT_HDR" id="VDR_REQ_ACT_HDR" value="<c:out value="${row.VDR_REQ_ACT_HDR}"/>" />
												</label>
											</div>
										</td>
									</tr>
	 		...
	 		if($frm.valid()){
                ...
                $("#VDR_REQ_MAIL").val($("#VDR_REQ_MAIL_ID").val() + "@" + $("#VDR_REQ_MAIL_DOMAIN").val());
           		...
           		if(confirm( "저장 하시겠습니까?")) {
   	                $frm.attr({"action":"<c:out value="${serverSslDomain}" />/pc/business/standingPointApplicationModify.do", "target":"_self", "method":"post"}).submit();
                }   
	        }
	    };

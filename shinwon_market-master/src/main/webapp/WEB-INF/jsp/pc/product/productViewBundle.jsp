								...
								<div class="slt_option">
									...
									<div class="pick_set">
										<div class="quantity">
											<ul>
												<li>
													<p class="tit">Champion - 액션 스타일 빅 로고 기모 후드 (PXEAD4073) / NAVY / XS / 01. 기본 베이직</p>
													<div class="b_slct">
									...
									<!-- <div class="pickup_info">
										...
										<button class="btn_small" data-type="layer" date-id="layer_store_select">매장선택</button>
									</div> -->
								</div>

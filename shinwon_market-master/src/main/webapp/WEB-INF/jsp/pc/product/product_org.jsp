...
<meta property="og:site_name" content="MarketPlant" /> 
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											주문번호, 고객명, 연락처, 이메일 주소를 함께 기재하셔서 보내신 후 쇼핑몰 고객센터 ()로 전화해 주시기 바랍니다.</p>
										</td>
									</tr>
									<tr>
    	...
    	if(memId == ""){
			...
			/* if(memGbn == ememType){
				if(confirm("마켓플랜트  통합회원 전용혜택입니다.\n통합회원으로 전환하시겠습니까?")){
					$('#couForm').attr({'action':'<c:out value="${serverDomain}" />/pc/manager/changeOnlineMemCert.do','method':'post'}).submit();	
				}
			}else{

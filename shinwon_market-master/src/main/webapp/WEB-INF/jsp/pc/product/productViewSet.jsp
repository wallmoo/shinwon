						...
						<div class="product_inform">
							...
							<div class="product_option ">
								...
								<div class="slt_option">
									<h3>세트상품 1 - 옵션선택</h3>
									<p class="tit_op">보카시 멜란지 울 혼방 정장세트 슬림핏 자켓 </p>
									...
									<div class="color_pick">
										<ul>
											<li class="atv">
												<input type="radio" id="color2-1" name="color2">
												<label for="color2-1">
													<span class="color" data-color="#071836" style="background-color:#071836">NAVY</span>
												</label>
											</li>
											<li>
												<input type="radio" id="color2-2" name="color2">
												<label for="color2-2">
													<span class="color" data-color="#40ba87" style="background-color:#40ba87">GREEN</span>
												</label>
											</li>
											<li>
												<input type="radio" id="color2-3" name="color2">
												<label for="color2-3">
													<span class="color" data-color="#febf4e" style="background-color:#febf4e">ORANGE</span>
												</label>
											</li>
											<li>
												<input type="radio" id="color2-4" name="color2">
												<label for="color2-4" class="contrast">
													<span class="color" data-color="#fee24e" style="background-color:#fee24e">YELLOW</span>
												</label>
											</li>
											<li>
												<input type="radio" id="color2-5" name="color2">
												<label for="color2-5" class="contrast">
													<span class="color" data-color="#fff5c7" style="background-color:#fff5c7">IVORY</span>
												</label>
											</li>
										</ul>
									...
									<div class="size">
										<ul>
											<li><input type="radio" id="size2-1" name="size2" checked="checked"><label for="size2-1">XS</label></li>
											<li><input type="radio" id="size2-2" name="size2"><label for="size2-2">S</label></li>
											<li><input type="radio" id="size2-3" name="size2"><label for="size2-3">M</label></li>
											<li><input type="radio" id="size2-4" name="size2" disabled="disabled"><label for="size2-4">L</label></li>
										</ul>
										<ul>
											<li><input type="radio" id="size2-5" name="size2" disabled="disable"><label for="size2-5">XL</label></li>
											<li><input type="radio" id="size2-6" name="size2"><label for="size2-6">XXL</label></li>
											<li><input type="radio" id="size2-7" name="size2"><label for="size2-7">XXXL</label></li>
										</ul>
										<button class="btn_small">재입고 알림</button>
									</div>
									<div class="option">
									...
									<div class="pick_set mt50">
										<div class="quantity">
											<ul>
												<li>
													<p class="tit">세트상품 1 - 보카시 멜란지 울 혼방 정장세트 슬림핏 자켓 (PXEAD4073) / NAVY / XS / 01. 기본 베이직</p>
													<div class="b_slct">
													...
													<!-- <div class="price_bx">
														<strong class="pri">￦44,000</strong>
														<button type="button" class="b_del">삭제</button>
													</div> -->
												</li>
												<li>
													<p class="tit">세트상품 2 - 보카시 멜란지 울 혼방 정장세트 슬림핏 자켓 (PXEAD4073) / NAVY / XS / 01. 기본 베이직</p>
													<div class="b_slct">
														<button type="button" class="minus">-</button>
														<input type="text" value="1">
														<button type="button" class="plus">+</button>
										...
										<div class="pickup_info_wp">
											<div class="pickup_info">
												...
												<button class="btn_small" date-type="layer" date-id="layer_store">매장선택</button>
												<script>

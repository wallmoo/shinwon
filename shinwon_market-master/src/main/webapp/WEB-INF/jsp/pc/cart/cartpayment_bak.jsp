        ...
        <div class="minW contents"><!-- contents S -->
			...
			<c:if test="${not empty sysRetailCartList}">
	            ...
	            <div class="cart-list-wrap price-king first-child"><!-- cart-list-wrap -->
	                <div class="section-title"><!-- section-title -->
	                    <h4 class="title">마켓플랜트 배송상품</h4>
	                    <div class="desc">
	                        	마켓플랜트 상품은 마켓플랜트 물류와 택배를 통해 안전하게 배송됩니다.
	                        <a href="javascript:com.laypop('show', '0');" class="link-guide"><span class="blind">안내</span></a>
	                    </div>
	                </div><!-- // section-title -->
	
	                <table class="table-product"><!-- table-product -->
	                <caption>상품/옵션 정보, 판매가, 수량, 즉시할인금액, 주문예정금액, 배송비로 구성된 마켓플랜트 배송상품 목록입니다.</caption>
                            ...
                            <ul>
                                <li class="article">
                                    <div class="module">
                                        ...
                                        <div class="col apply">
                                            ...
                                            <span class="desc dotum">예금주명 : (주)이패스씨앤아이 </span>
                                        </div>
                                    </div>
                                </li>
                                <li class="article">
                                ...
                                <li class="article escrowa pay-way pay-way_${Code.PAY_ESCROW}">
                                    <div class="module">
                                        ...
                                        <a href="http://www.etland.co.kr/etland/order/kicc/escrow/html/escrow_info.html" class="btn_st0 btn_white small" target="_blank" title="새 창 열림"><span>약관보기</span></a>
                                        <p>
            ...
            <div id="laypop" class="laypop">
                <div id="priceKingGuide" class="laypop_con layer-popup"><!-- #priceKingGuide -->
                    <h5 class="title h1">마켓플랜트 배송상품 유의사항</h5>
                    <div class="holder">
                        <p class="message">

	...
	<div id="popContainer"><!-- popContainer -->
	    ...
	    <div id="popWrapper" class="zip-search"><!-- popWrapper -->
	        ...
	        <ul class="ct tab-a"><!-- tab-a -->
	            ...
	            <li class="active"><a href="javascript:;"><span>지번 검색</span></a><span class="blind">현재위치</span></li>
...
<%-- 				<input type="hidden" name="searchType" id="searchType" value="${commandMap.searchType != null ? commandMap.searchType : 'BASIC'}"> --%>
	        ...
	        <ul class="list list-a">
	            <li>찾고 싶으신 동/읍/면/리와 번지를 입력해 주세요.</li>
	        ...
	        <div class="search"><!-- search -->
	            <div class="holder">
	                <div>
	                    ...
	                    <span class="article">
	                        <span class="essential"><em class="blind">필수입력</em></span>
	                        <input type="text" class="text" id="dong" maxlength="15" placeholder="읍/면/동/리 입력" title="읍/면/동/리" value="<c:out value="${commandMap.searchDong }"/>" />
	                    </span>
	                </div>
	                <div class="mt10">
	                    <label for="jibunNo"><strong>번지</strong></label>
	                    <input type="checkbox" class="checkbox" name="MOUNT_YN" id="MOUNT_YN" value="1" <c:if test="${commandMap.searchMountYn eq '1'}">checked="checked"</c:if>/>
	                    <label for="MOUNT_YN">산</label>
	                    <span class="article">
	                        <!-- <span class="essential"><em class="blind">필수입력</em></span> -->
	                        <input type="text" class="text small number" id="jinoMain" title="번지_본번" placeholder="본번" value="<%=searchJinomain%>"/> -
	                        <input type="text" class="text small number" id="jinoSub" title="번지_부번" placeholder="부번" value="<%=searchJinosub%>"/>
	                    </span>
	        ...
	        <caption>번호, 주소, 우편번호로 구성된 우편번호 지번 검색 결과 목록입니다.</caption>
	        <colgroup>
	            <col style="width: 10%;" />
	            <col style="width: 15%;" />
	            <col style="width: 13%;" />

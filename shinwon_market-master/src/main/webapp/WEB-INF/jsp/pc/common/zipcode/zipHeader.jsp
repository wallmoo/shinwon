<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ include file="/WEB-INF/jsp/pc/search/common_zip/WNSearch.jsp"%>
<%
...
<%
	...
	String searchBuildMainNo = getCheckReqXSS(request,"searchBuildMainNo", ""); //건물본번
	String searchBuildSubNo = getCheckReqXSS(request,"searchBuildSubNo", ""); //건물부번
	String searchJinomain = getCheckReqXSS(request, "searchJinomain",""); //지번본번

			...
			<div class="sub_content">
				<div class="tab_wrap">
					<ul class="tab n2">
						...
						<li><a href="<c:out value="${serverDomain }"/>/pc/manager/pwFind.do?gubun=PW">비밀번호 찾기</a></li>
					</ul>
...
<script>
	$(function(){
		...
		*/
	    ...
	    {
	    	$basicForm.attr({"action":"<c:out value="${serverSslDomain}" />/pc/manager/idFindResult.do", "target":"_self", "method":"post"}).submit();
	    };
	    ...
	    goIdFind = function()
	    {
	    	...
	    	if(searchType == "memberSimple"){
	    		...
	    		if($simpleForm.valid()){
	    			$simpleForm.attr({"action":"<c:out value="${serverSslDomain}" />/pc/manager/idFindResult.do", "target":"_self", "method":"post"}).submit();	    			
	    		}	    			
			}
	    	// 기업회원의 경우
	    	if(searchType == "memberBusiness"){
	    		...
	    		if($businessForm.valid()){
	    			$("#businessForm").attr({"action":"<c:out value="${serverSslDomain}" />/pc/manager/idFindResult.do", "target":"_self", "method":"post"}).submit();	    			
	    		}
	    	}
	    };

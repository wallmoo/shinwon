...
<div class="modal">
	<div class="modal-wrapper">
	    <div class="modal-inner">
            ...
            <h2 class="title"><span>회원검색</span></h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="select">
                                        ...
                                        <option value="">Lv.5</option>
                                        <option value="">Lv.6</option>
                                    </select>
                                </td>
                            </tr>
                        </tbody>

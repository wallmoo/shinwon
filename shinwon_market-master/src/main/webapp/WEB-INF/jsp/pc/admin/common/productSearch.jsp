                    ...
                    <table cellspacing="0" class="table-col table-b"><!-- table -->
                        ...
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2">상품명</th>
                                <th rowspan="2">일반가(Tag가)</th>
                                <th rowspan="2">판매가</th>
                                <th>브랜드</th>
                                <th rowspan="2">판매상태</th>
                            </tr>
                            <tr>
                                <th class="border-left">입점업체</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td rowspan="2"><input type="checkbox" class="checkbox"></td>
                                <td rowspan="2"><span class="thumbnail_img"><img src="../profile.jpg"></span></td>
                                <td rowspan="2"><a href="#">PYFAI4229</a></td>
                                <td rowspan="2"><a href="#">[SIEG◆1212][30%쿠폰]브라운 스트레이트</a></td>
                                <td rowspan="2">9,999,999</td>
                                <td rowspan="2">4,999,999</td>
                                <td>viki</td>
                                <td rowspan="2">판매중</td>
                            </tr>
                            <tr>
                                <td class="border-left">신원</td>
                            </tr>
                        </tbody>
                    </table>

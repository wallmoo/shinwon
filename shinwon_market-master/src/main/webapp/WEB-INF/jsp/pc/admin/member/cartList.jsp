                    ...
                    <table cellspacing="0" class="table-row table-a"><!-- table -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="searchPrdMstCd" id="searchPrdMstCd" class="text" value="">
                                </td>
                                <th><span>상품명</span></th>
                                <td>
                                    <input type="text" name="searchPrdMstNm" id="searchPrdMstNm" class="text" value="">
                                </td>
                            </tr>
                        </tbody>
                    </table><!-- // table -->
                   ...
                   <table cellspacing="0" class="table-col table-b"><!-- table -->
                       ...
                       <thead>
                        ...
                        <tbody id="list-field">
                            <tr>
                                <td>1</td>
                                <td><a href="#">S0011956</a></td>
                                <td><a href="#">베스트밸리</a></td>
                                <td><a href="#">완전기모패딩</a></td>
                                <td>블랙 / 85</td>
                                <td>1</td>
                                <td>95,000원</td>

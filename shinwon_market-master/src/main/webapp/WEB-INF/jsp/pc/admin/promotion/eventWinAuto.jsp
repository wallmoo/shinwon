	...
	<div class="modal">
		...
		<div class="modal-wrapper">
			...
			<div class="modal-inner">
				...
				<h2 class="title"><span>당첨자 자동선정</span></h2>
                        ...
                        <input type="hidden" name="PLN_PRD_CTG_TOP_NM" id="PLN_PRD_CTG_TOP_NM" value="" />
    			  		...
    			  		<table cellspacing="0" class="table-row table-a"><!-- table -->
    	                    ...
    	                    <tbody>
                                ...
                                <tr>
    	                    		<th><label class="label"><span>당첨자<i class="require"><em>필수입력</em></i></span></label></th>
    	                    		<td>
                                        <input type="text " class="text" name="" value="">명 (최대 당첨 가능수 : <em style="color:blue;font-style:normal;">40</em>명)
    	                    		</td>
    	                        </tr>
                                <tr>

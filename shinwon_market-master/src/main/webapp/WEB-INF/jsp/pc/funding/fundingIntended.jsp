           ...
           <%@ include file="/WEB-INF/jsp/pc/include/location.jsp"%>
            ...
            <div class="funding_top_area clearboth">
                ...
                <div class="funding_slide_banner_wrap clearboth">
                    <div class="funding_slide_banner_01">
                        <div>
                            <a href="/pc/funding/fundingIntendedView.do" class="slide_item">
            ...
            <div class="tabmenuWrap">
                <ul class="tabmenu_list cf">
                    <li><a href="/pc/funding/fundingList.do">진행중</a></li>
                    <li class="on"><a href="#">오픈예정</a></li>
                    <li><a href="#">종료</a></li>
                </ul>
            </div>
            <!-- // .tabmenuWrap -->
            ...
            <!-- .sub_content -->
            <div class="sub_content funding funding_info">
                    ...
                    <ul class="goods_list clearboth">
                        <li>
                            ...
                            <div class="goods_info_wrap">
                                <a href="/pc/funding/fundingIntendedView.do">
                                    <!-- .thum_colorinfo -->
                                    <!--
                                    ...
                                    <div class="thum_info_txt">
                                        <p class="funding_open_info">10월 22일 오픈 예정</p>
                                        <div class="sort_tag_area clearboth">
                                                <span class="sort">SIEG</span>
                                                <span class="tag">#타임특가</span>
                                        </div>
                                        <p class="goods_title">스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백스퀘어 스카프 토드백</p>
                                        <p class="goods_context">산뜻한 하루를 만드는 룩!<br />#체크남방 #반바지 #뷔스티에 #원피스</p>
                                    </div>
                                </a>
                                <div class="funding_btn">
                                    <div class="btn_wrap">
                                        <button class="btn_large">펀딩시작 알림</button>
                                    </div>

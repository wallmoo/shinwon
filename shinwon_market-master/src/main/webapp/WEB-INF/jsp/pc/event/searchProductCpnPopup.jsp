	                            ...
	                            <div class="module">
	                                ...
	                                <span class="tx_tate">
	                                	<c:choose>
	                                		...
	                                		<c:when test="${list.CPN_MST_ISU_DAY_GBN eq 'M' }">
	                                			발행 당월말까지 사용
	                                		</c:when>
	                                		<c:otherwise>
...
$(function(){
	getCouponDwn = function(){
		var $frm = $("#frm"); 
		$frm.attr({"action":"<c:out value="${frontDomain}" />/pc/event/ProductCouponRegist.do", "target":"_self", "method":"post"}).submit();
	};
}); //function

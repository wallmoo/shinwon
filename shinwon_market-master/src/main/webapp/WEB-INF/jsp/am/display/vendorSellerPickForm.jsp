                ...
                <table cellspacing="0" class="table-row table-a"><!-- table -->
                    ...
                    <tbody>
                        <tr>
                            <th><span>작성자</span></th>
                            <td>
                                <input type="text" name="CNT_MST_REG_ID" id="CNT_MST_REG_ID" value="<c:out value="${sessionAdmin.ADM_MST_ID }"/>(<c:out value="${sessionAdmin.ADM_MST_NM }"/>)" readonly>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small class="desc">이미지 사이즈 : 000*000 / 업로드 가능 파일 : jpg, gif, png / 업로드 용량 : 1M</small>
                                <p class="img-text">
                                    <span>대체텍스트</span> <input type="text" name="CMN_FLE_ALT_TXT_M1" id="CMN_FLE_ALT_TXT_M1" class="text xlarge pcImgFile" placeholder="20자 이내로 입력하세요." data-caption="대체텍스트"/>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <tr class="detailTypeImage" >
                                ...
                                <td>
                                    ...
                                    <input type="file" name="mobileFile" id="multiFile5" class="file mobileImgFile" data-attach_cnt="1" accept=".jpg, .png, .gif" />
                                    <small class="desc">이미지 사이즈 : 000*000 / 업로드 가능 파일 : jpg, gif, png / 업로드 용량 : 1MB / 이미지 최대 10개 등록</small>
                                    <p class="img-text">
...
$(function(){
    ...
    $(document).on("click", "#goRegist", function() {
        ...
        if($frm.valid())
        {
            ...
            {
                $("#frm").attr({"action" : "<c:out value="${serverDomain}" />/am/display/vendorSellerPickRegist.do", "target" : "_self", "method" : "post"}).submit();
            }
        }

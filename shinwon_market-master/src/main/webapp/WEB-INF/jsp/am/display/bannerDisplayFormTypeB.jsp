...
<form name="frm" id="frm" enctype="multipart/form-data">
	...
	<table cellspacing="0" class="table-row table-a"><!-- table -->
		...
		<tbody>
			...
			<tr>
				<th><label class="label"><span>배너1 <i class="require"><em>필수입력</em></i></span></label></th>
				<td>
					<input type="file" name="file" id="file1" class="file"/>
				</td>
			</tr>
			<tr>
				<th><label class="label"><span>배너2 <i class="require"><em>필수입력</em></i></span></label></th>
				<td>
...
var fileFlag = true;
	...
	goRegist = function () {
		...
		if($frm.valid())
		{
			...
			if($("#CMN_COM_IDX").val() == "2335"){
				if($("#BNR_MST_SUB_TITLE").val() == ""){
					alert("서브 타이틀을 입력해주세요.");
					$("#BNR_MST_SUB_TITLE").focus();
					return;
				}
			}

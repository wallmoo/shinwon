                ...
                <h3 class="title">브랜드전시-아낙</h3>
                 ...
                 <div class="tab-a justified" style="margin-top: 20px; width: 100%"><!-- tab -->
                    <ul class="tab">
                        ...
                        <li id="ANAC_TOP7_TAB"  class = "active" ><a href="javascript:fnAnacChangeTab('TOP7');" >TOP7</a></li>
...
$(document).ready(function () {
    ...
    $(document).on("click", "#goForm", function () {
        $("#frm").attr({"action":"<c:out value="${serverDomain}" />/am/display/anacTopForm.do", "target":"_self", "method":"post"}).submit();
    });
    ...
    $(document).on("click", "#list-field .list-title", function () {
        ...
        $frm.attr({"action":"<c:out value="${serverDomain}" />/am/display/anacTopEdit.do", "target":"_self", "method":"post"}).submit();
    ...
    goPage = function (cPage) 
    {
        ...
        $frm.attr({"action":"<c:out value="${serverDomain}" />/am/display/anacTopList.do", "target":"_self", "method":"post"}).submit();
    };

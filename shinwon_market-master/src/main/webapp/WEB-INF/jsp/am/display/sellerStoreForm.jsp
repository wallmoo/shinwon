			...
			<table class="table-row table-a">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="SEL_SHP_NM" id="SEL_SHP_NM" class="text large"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<span>-</span>
							<input type="text" name="SEL_SHP_TEL2" id="SEL_SHP_TEL2" class="text">
							<span>-</span>
							<input type="text" name="SEL_SHP_TEL3" id="SEL_SHP_TEL3" class="text">
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="tbl_line">
								<input type="text" name="SEL_SHP_ZIP_NO" id="SEL_SHP_ZIP_NO" class="text onlyNumber" readonly="readonly">
								<a href="javascript:;" id="zipCheck" class="button button-a"><span>우편번호 찾기</span></a>
							</div>
							<div class="tbl_line">
								<input type="text" name="SEL_SHP_ADDR1" id="SEL_SHP_ADDR1" class="text half" readonly="readonly">
								<input type="text" name="SEL_SHP_ADDR2" id="SEL_SHP_ADDR2" class="text large" placeholder="나머지 주소 입력">
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<ul class="form_radio_check_list">
								<li>
									<input type="radio" name="SEL_SHP_USE_YN" id="stateA" value="Y" class="radio" checked="checked">
									<label for="stateA">사용</label>
								</li>
								<li>
									<input type="radio" name="SEL_SHP_USE_YN" id="stateB" value="N" class="radio">
...
$(function(){
	...
	$("#frm").validate({
        rules: {
        	...
        	SEL_SHP_ZIP_NO:{required:true, number:true, maxlength:5},
        	SEL_SHP_ADDR1 :{required:true},
        	SEL_SHP_ADDR2 :{required:true},
        ...
        messages :{
        	...
        	SEL_SHP_ZIP_NO:{required:"[우편번호]를 검색해주세요."},
        	SEL_SHP_ADDR1:{required:"[주소]는 필수 입력사항입니다."},
        	SEL_SHP_ADDR2:{required:"[주소]는 필수 입력사항입니다."},
	...
	$(document).on("click", "#goRegist", function () {
        ...
        if($frm.valid()){
            ...
            if (confirm( "저장 하시겠습니까?")) {
                $("#frm").attr({"action":"<c:out value="${serverDomain}" />/am/display/sellerStoreRegist.do", "target":"_self", "method":"post"}).submit();
            }
        }
    });

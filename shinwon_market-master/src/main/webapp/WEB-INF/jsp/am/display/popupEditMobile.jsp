		...
		<div id="contents"><!-- contents -->
			...
			<div class="container">
				...
				<form id="frm" name="frm" enctype="multipart/form-data">
					...
					<input type="hidden" name="cPage" value="<c:out value="${commandMap.cPage }"/>"/>
					<input type="hidden" name="pageSize" value="<c:out value="${commandMap.pageSize }"/>"/>
					<input type="hidden" name="POP_MST_VIEW_ENV" value="M" />
					<input type="hidden" id="POP_MST_IDX" name="POP_MST_IDX" value="<c:out value="${popupInfo.POP_MST_IDX }"/>" />
					<input type="hidden" name="searchPopMstTopYn" value="<c:out value="${commandMap.searchPopMstTopYn }"/>"/>

					<input type="hidden" name="POP_MST_CHN_GBN" value="M" />
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<textarea class="textarea xlarge" name="POP_MST_CNT" id="POP_MST_CNT" style="width: 95%; height: 500px;"><c:out value="${popupInfo.POP_MST_CNT}"/></textarea>
								</td>
							</tr>
...
<ui:editor objId="#POP_MST_CNT" num="2"/>
...
$(function(){
	...
	{
		try { oEditors2.getById["POP_MST_CNT"].exec("UPDATE_CONTENTS_FIELD", []);     } catch(e){ }
		var $frm = $("#frm");
		if($frm.valid()){

...
<c:set var="CONST_TOP" value="<%= DSP_BAN_CODE.DSP_BAN_TOP %>"/>
<c:set var="CONST_BAN" value="<%= DSP_BAN_CODE.DSP_BAN_EVENT_BAN %>"/>
	...
	<div class="grid section-button-list"><!-- 목록 상단 버튼 -->
		...
		<table class="table-col table-b">
			<colgroup>
				...
				<c:if test="${bnrCatList[0].CMN_COM_ETC1 eq CONST_TOP || 
		...
		<div class="section-button">
			<div class="wrap text-center">
				<a href="javascript:;" id="modifySort" class="button primary"><span>저장</span></a>
			</div>
		</div>

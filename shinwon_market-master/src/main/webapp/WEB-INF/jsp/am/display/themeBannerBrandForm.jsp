		...
		<tbody>
			...
			<tr>
				...
				<td>
	            	...
	            	<input type="text" name="file" id="file" disabled />
	            	<input type="hidden" id="BND_MST_IDX" name="BND_MST_IDX"  />
				    <input type="hidden" id="BNR_MST_NM" name="BNR_MST_NM"  />
				    <input type="hidden" id="BNR_MST_SERV" name="BNR_MST_SERV"  />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea  name="BNR_MST_DESC" id="BNR_MST_DESC" class="textarea xlarge" style="width: 80%;" maxlength="300"></textarea>
				</td>
			</tr>

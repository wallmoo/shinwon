	...
	<table cellspacing="0" class="table-row table-a"><!-- table -->
		...
		<tbody>
			...
			<tr>
				...
				<td>
		            https://youtu.be/ <input type="text" name="BNR_MST_MOV_URL" id="BNR_MST_MOV_URL" class="text" style="width: 80%;" maxlength="200"  value="<c:out value="${row.BNR_MST_MOV_URL }"/>" />
					<br />
				</td>
			</tr>			
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" class="checkbox" id="CMM_FLE_IDX" name="CMM_FLE_IDX" value="<c:out value="${row.CMM_FLE_IDX }"/>" />
 ...
 // 폼체크
    $("#frm").validate({
        rules: 
        {
            ...
            BNR_MST_MOV_URL:{required:true}, // 유튜브URL 

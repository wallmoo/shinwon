					...
					<table cellspacing="0" class="table-row table-a"><!-- table -->
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="tbl_line">
										<input type="radio" name="AD_MST_LNK_GBN" id="AD_MST_LNK_GBN1" class="AD_MST_LNK_GBN" value="" checked="checked"><label for="AD_MST_LNK_GBN1">링크없음</label>
										<input type="radio" name="AD_MST_LNK_GBN" id="AD_MST_LNK_GBN2" class="AD_MST_LNK_GBN" value="P"><label for="AD_MST_LNK_GBN2">부모창</label>
										<input type="radio" name="AD_MST_LNK_GBN" id="AD_MST_LNK_GBN3" class="AD_MST_LNK_GBN" value="N"><label for="AD_MST_LNK_GBN3">새창열림</label>
									</div>
									<div class="tbl_line">	

		...
		<div id="body">
			...
			<section id="contents"><!-- contents -->
	            ...
	            <div class="contents-inner"><!-- contents-inner -->
	                ...
	                <div class="title-box">
	                    <h4 class="title">등록-REAL ANAC</h4>
	                </div>
	                ...
	                <form name="frm" id="frm" enctype="multipart/form-data">
		                ...
		                <div class="section-form"><!-- section-form-a -->
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="radio" name="ANA_RAL_DPL_YN" id="stateA" class="radio" value="Y" checked="checked"/>
		                            <label for="stateA">전시</label>
		                            <input type="radio" name="ANA_RAL_DPL_YN" id="stateB" class="radio" value="N" />
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="radio" name="ANA_RAL_NEW_YN" id="stateA" class="radio" value="Y"/>
		                            <label for="stateA">YES</label>
		                            <input type="radio" name="ANA_RAL_NEW_YN" id="stateB" class="radio" value="N" checked="checked"/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="text" name="PRD_MST_CD" id="PRD_MST_CD" class="text"/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                        	<span id="PRD_MST_ERP_CD"></span>
		                        </div>
		                    </div>
		                     <div class="form-group">
		                        <label class="label"><span>상품명</span></label>
		                        <div class="field">
		                        	<span id="PRD_MST_NM"></span>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="label"><span>링크1(SNS)</span></label>
		                        <div class="field">
		                            <input type="text" name="ANA_RAL_SNS_LNK" id="ANA_RAL_SNS_LNK" class="text long"/>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="label"><span>링크2(상세) <em class="strong">*</em></span></label>
		                        <div class="field">
		                            <input type="text" name="ANA_RAL_DTL_LNK" id="ANA_RAL_DTL_LNK" class="text long"/>
		                            <a href="javascript:fnPreview()" class="button button-a small"><span>보기</span></a>
		                        </div>
		                    </div>
...
$(document).ready(function() {
    ...
    $(document).on("click", "#goRegist", function() {
    	...
    	if($.trim($("#ANA_RAL_DTL_LNK").val()) == ""){
			alert("링크2(상세)를 입력해 주십시오.");
			$("#ANA_RAL_DTL_LNK").focus();
			return;
		}
     	
        if (confirm("저장 하시겠습니까?")) 
        {
        	$("#frm").attr({"action" : "<c:out value="${serverDomain}" />/am/display/anacRealRegist.do", "target" : "_self", "method" : "post"}).submit();
        }    

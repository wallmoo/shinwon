...
$(document).ready(function () {
	...
	search = function(){
		...
		$searchForm.attr({"action":"<c:out value="${serverDomain}" />/am/display/sellerRoomBannerView.do", "target":"_self", "method":"post"}).submit(); 
	};
	...
	function sellerBannerCategoryList(USER_ENV_TYPE){
		$.postSyncJsonAjax("/am/display/sellerRoomBannerAjax.do", { searchGubun : USER_ENV_TYPE }, function(data){

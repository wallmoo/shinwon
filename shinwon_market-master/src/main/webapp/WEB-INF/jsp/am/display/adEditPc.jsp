		...
		<div id="contents"><!-- contents -->
			...
			<div class="container">
				...
				<form id="searchForm" name="searchForm">
					...
					<input type="hidden" name="AD_MST_VIEW_ENV" value="P" />  
				</form>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<select id="AD_MST_ST_HH" name="AD_MST_ST_HH" class="select small">
									...
									<select id="AD_MST_ST_MM" name="AD_MST_ST_MM" class="select small">
									...
									<select id="AD_MST_ED_HH" name="AD_MST_ED_HH" class="select small">
										<c:forEach begin="0" end="23" step="1" var="i" varStatus="status">
											<fmt:formatNumber pattern="00" value="${i }" var="hour" />
											<option value="${hour }" <ui:select v="${ adInfo.AD_MST_ED_HH  }" t="${hour }" g="selected"/>>${hour }</option>
										</c:forEach>
									</select> 시
									<select id="AD_MST_ED_MM" name="AD_MST_ED_MM" class="select small">
										<c:forEach begin="0" end="59" step="1" var="i" varStatus="status">
											<fmt:formatNumber pattern="00" value="${i }" var="minute" />
							...
							<tr>
								...
								<td>
									<div class="tbl_line">
										<input type="radio" name="AD_MST_LNK_GBN" id="AD_MST_LNK_GBN1" class="AD_MST_LNK_GBN" value="" <ui:select v="${adInfo.AD_MST_LNK_GBN }" t="" g="checked"/>>
										<label for="AD_MST_LNK_GBN1">링크없음</label>
										<input type="radio" name="AD_MST_LNK_GBN" id="AD_MST_LNK_GBN2" class="AD_MST_LNK_GBN" value="P" <ui:select v="${adInfo.AD_MST_LNK_GBN }" t="P" g="checked"/>>
										<label for="AD_MST_LNK_GBN2">부모창</label>
										<input type="radio" name="AD_MST_LNK_GBN" id="AD_MST_LNK_GBN3" class="AD_MST_LNK_GBN" value="N" <ui:select v="${adInfo.AD_MST_LNK_GBN }" t="N" g="checked"/>>
										<label for="AD_MST_LNK_GBN3">새창열림</label>
									</div>
									<div class="tbl_line">

	...
	<table cellspacing="0" class="table-row table-a"><!-- table -->
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<div class="tbl_line">
						<input type="radio" name="BNR_MST_URL_POP" id="BNR_MST_URL_POP1" value="N" <ui:select v="${row.BNR_MST_URL_POP }" t="" g="checked"/>><label for="BNR_MST_URL_POP1">링크없음</label>
						<input type="radio" name="BNR_MST_URL_POP" id="BNR_MST_URL_POP2" value="P" <ui:select v="${row.BNR_MST_URL_POP }" t="C" g="checked"/>><label for="BNR_MST_URL_POP2">현재창</label>
						<input type="radio" name="BNR_MST_URL_POP" id="BNR_MST_URL_POP3" value="O" <ui:select v="${row.BNR_MST_URL_POP }" t="N" g="checked"/>><label for="BNR_MST_URL_POP3">새창열림</label>
					</div>
					<div class="tbl_line">
			...
			<tr>
				<th><label class="label"><span>1일 닫기<i class="require"><em>필수입력</em></i></span></label></th>
				<td>
					<select class="BNR_MST_CLS_USE_YN" name="BNR_MST_CLS_USE_YN">
						<option value="Y" <c:if test="${row.BNR_MST_CLS_USE_YN eq 'Y'}">selected</c:if>>사용</option>
						<option value="N" <c:if test="${row.BNR_MST_CLS_USE_YN eq 'N'}">selected</c:if>>미사용</option>
					</select>
				</td>
			</tr>
			<tr>

	                ...
	                <form name="frm" id="frm" enctype="multipart/form-data">
		                ...
		                <div class="section-form"><!-- section-form-a -->
	 	                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="radio" name="ANA_ITM_DPL_YN" id="stateA" class="radio" value="Y" <c:if test="${row.ANA_ITM_DPL_YN eq 'Y'}"> checked="checked" </c:if>/>
		                            <label for="stateA">전시</label>
		                            <input type="radio" name="ANA_ITM_DPL_YN" id="stateB" class="radio" value="N" <c:if test="${row.ANA_ITM_DPL_YN eq 'N'}"> checked="checked" </c:if>/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="text" name="ANA_ITM_PRD_NM" id="ANA_ITM_PRD_NM" class="text long ANA_ITM_PRD_NM" value="<c:out value="${row.ANA_ITM_PRD_NM }"/>"/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="text" name="ANA_ITM_PRD_MST_CD" id="ANA_ITM_PRD_MST_CD" class="text" value="<c:out value="${row.ANA_ITM_PRD_MST_CD }"/>"/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="text" name="ANA_ITM_PRD_SPC" id="ANA_ITM_PRD_SPC" class="text long ANA_ITM_PRD_SPC" value="<c:out value="${row.ANA_ITM_PRD_SPC }"/>"/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="text" name="ANA_ITM_CLR" id="ANA_ITM_CLR" class="text long ANA_ITM_CLR" value="<c:out value="${row.ANA_ITM_CLR }"/>"/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="checkbox" class="checkbox" name="ANA_ITM_NEW_YN" id="ANA_ITM_NEW_YN" value="Y"  <ui:select v="${row.ANA_ITM_NEW_YN }" t="Y" g="checked"/>/>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                            <input type="checkbox" class="checkbox" name="ANA_ITM_BST_YN" id="ANA_ITM_BST_YN" value="Y" <ui:select v="${row.ANA_ITM_BST_YN }" t="Y" g="checked"/>/>
		                        ...
		                        <div class="field">
		                        	 <select id="ANA_ITM_CTG" name="ANA_ITM_CTG" class="select" title="카테고리">
    									...
    									<c:forEach items="${categoryList}" var="data">
     									<option value="<c:out value="${data.CMN_COM_IDX}"/>"  <ui:select v="${data.CMN_COM_IDX}" t="${row.ANA_ITM_CTG}" g="selected"/>>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="field">
		                        	 <textarea class="textarea ANA_ITM_MD_TAK" name="ANA_ITM_MD_TAK" id="ANA_ITM_MD_TAK" style="height: 60px;"><c:out value="${row.ANA_ITM_MD_TAK }"/></textarea>
	 	                    ...
	 	                    <div class="form-group">                    
		                        <div class="col">
									...
									<div class="field">
										<c:out value="${row.ANA_ITM_REG_NM }"/>(<c:out value="${row.ANA_ITM_REG_ID }"/>), <ui:formatDate value="${row.ANA_ITM_REG_DT }" pattern="yyyy.MM.dd HH:mm:ss"/>
									</div>
		                        </div>
							</div>
...
$(document).ready(function() {
	...
	$("#ANA_ITM_PRD_SPC").trigger("keyup");
	$("#ANA_ITM_CLR").trigger("keyup");
	$("#ANA_ITM_MD_TAK").trigger("keyup");
    ...
    $(document).on("click", "#goRegist", function() {
        ...
        {	 
        	$("#frm").attr({"action" : "<c:out value="${serverDomain}" />/am/display/anacItemsModify.do", "target" : "_self", "method" : "post"}).submit();	
        }    

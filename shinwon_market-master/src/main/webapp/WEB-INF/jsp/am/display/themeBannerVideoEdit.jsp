...
<form name="frm" id="frm" enctype="multipart/form-data">
	...
	<table cellspacing="0" class="table-row table-a"><!-- table -->
		...
		<tbody>
			...
			<tr>
				<th><label class="label"><span>상세 문구 <i class="require"><em>필수입력</em></i></span></label></th>
				<td>
					<textarea type="text" name="BNR_MST_DESC" id="BNR_MST_DESC" class="textarea xlarge" style="width: 80%;" maxlength="300">${row.BNR_MST_DESC }</textarea>
				</td>
			</tr>

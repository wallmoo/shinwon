	...
	<table cellspacing="0" class="table-row table-a"><!-- table -->
		...
		<tbody>
			...
			<tr>
				...
				<td>
		            https://youtu.be/ <input type="text" name="BNR_MST_MOV_URL" id="BNR_MST_MOV_URL" class="text" style="width: 80%;" maxlength="200"   />
					<br />
				</td>
			</tr>	
			...
			<tr>
				...
				<td>
					<input type="file" name="file" id="file" class="file" accept=".png, .jpg"/>

            ...
            <div class="container"><!-- container -->
                ...
                <div class="tab-list"><!-- tab -->
                    <ul class="tab">
                        ...
                        <li class="in"><a href="#none">가입경로</a></li>
                    ...
                    <c:choose>
                        <c:when test="${not empty list}">
                            <c:forEach items="${list}" var="data" varStatus="i">
                                <tr>
                                    <td><c:out value="${empty data.MEMB_JOIN_DE ? '총 회원수' : data.MEMB_JOIN_DE}"/></td>
...
$(function () {
    ...
    goSearch = function()
    {
        ...
        //$searchForm.attr({"action":"<c:out value="${serverDomain}" />/am/stats/memberJoinPathDateList.do", "target":"_self", "method":"get"}).submit();
    };
    ...
    goExcelDown = function ()
    {
        ...
        var $frm = $("#frm");
        $frm.attr({"action":"<c:out value="${serverDomain}"/>/am/stats/memberJoinPathDateListExcel.do", "target":"_self", "method":"get"}).submit();
    };

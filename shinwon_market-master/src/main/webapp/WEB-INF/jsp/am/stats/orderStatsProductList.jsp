            ...
            <div class="container"><!-- container -->
                ...
                <div class="tab-list"><!-- tab -->
                    <ul class="tab">
                        ...
                        <li class="active"><a href="<c:out value="${serverDomain}" />/am/stats/orderStatsProductList.do">판매상품</a></li>
                ...
                <div class="section-title"><!-- section-title -->
                    <h3 class="title"><span>조회결과<strong class="primary"> (단위:원, VAT 포함)</strong></span></h3>
                    <div class="more">
                        ...
                        <c:when test="${not empty list}">
                            <c:forEach items="${list}" var="data" varStatus="i">
                                <tr>
                                    ...
                                    <td><c:out value="${data.PRD_MST_NM}"/><br/><c:out value="${data.PRD_MST_CD}"/> <br /> (<c:out value="${data.PRD_MST_ERP_CD}" />)</td>
                                    <td>10</td>
                                    <td>1,000,000</td>
                                    <td>10</td>
                                    <td>1,000,000</td>
                                    ...
                                    <td>10</td>
                                    <td>1,000,000</td>
                                    <!--<td><fmt:formatNumber value="${data.PAY_ORD_PRD_ORD_CNT}" type="number"/></td>
                                    <td><fmt:formatNumber value="${data.PAY_ORD_PRD_ORD_PRC}" type="number"/></td>
                                    <td><fmt:formatNumber value="${data.CANCEL_ORD_PRD_ORD_CNT}" type="number"/></td>
                                    <td><fmt:formatNumber value="${data.CANCEL_ORD_PRD_ORD_PRC}" type="number"/></td>
                                    <td><fmt:formatNumber value="${data.RETURN_ORD_PRD_ORD_CNT}" type="number"/></td>
                                    <td><fmt:formatNumber value="${data.RETURN_ORD_PRD_ORD_PRC}" type="number"/></td>-->
                                </tr>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
                            <c:if test="${commandMap.searchYn eq 'Y'}">
                                <tr>
                                    <td colspan="13">${Code.COMMON_MESSAGE_SEARCH_RESULT_NONE_}</td>
                                </tr>
                            </c:if>
                            <c:if test="${commandMap.searchYn ne 'Y'}">
                                <tr>
                                    <td colspan="13">${Code.COMMON_MESSAGE_DO_SEARCH_}</td>
                                </tr>
                            </c:if>
                        </c:otherwise>
                    </c:choose>
...
//      getCategoryList("searchPrdCtgDepth1", "-1", "<c:out value="${commandMap.searchPrdCtgDepth1}" />", "<c:out value="${serverDomain}"/>");
    ...
    goSearch = function()
    {
        ...
        $searchForm.attr({"action":"<c:out value="${serverDomain}" />/am/stats/orderStatsProductList.do", "target":"_self", "method":"get"}).submit();
        */
    };
    ...
    goExcelDown = function ()
    {
        ...
        var $frm = $("#frm");
        $frm.attr({"action":"<c:out value="${serverDomain}"/>/am/stats/orderStatsProductListExcel.do", "target":"_self", "method":"get"}).submit();
    };

    ...
    <div id="wrapper"><!-- wrapper -->
        ...
        <div id="contents"><!-- contents -->
            ...
            <div class="container"><!-- container -->
                ...
                <c:if test="${commandMap.CPN_MST_YN eq 'Y' }">
	                <div class="tab-list"><!-- tab -->
	                    <ul>
	                        <li class="in"><a href="#none">발행내역</a></li>
	                        <li><a href="javascript:;" id="goEventEntryList">관리자 발급</a></li>
	                    </ul>
	                </div><!-- // tab -->
                </c:if>
                <c:if test="${commandMap.CPN_MST_YN eq 'N' }">
                   <div class="tab-list"><!-- tab -->
	                    <ul>
	                        <li class="in"><a href="#none">발행내역</a></li>
	                        <li><a href="#none">관리자 발급</a></li>
	                    </ul>
	                </div><!-- // tab -->
                </c:if>
                    ...
                    <table cellspacing="0" class="table-row table-a"><!-- table -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>${commandMap.CPN_MST_GBN_NM}</td>
                            </tr>
                            <tr>
                         	...
                         	<c:when test="${not empty list }">
                               	...
                               	<c:forEach var="row" items="${list }" varStatus="i">
                               		<tr>
			                         	...
			                         	<td>
			                             	<a class="memId" href="javascript:goMemberViewPopup('<c:out value="${serverDomain}" />','<c:out value="${row.CPN_MEM_ID }" />');" title="새 창 으로 열립니다."><c:out value="${row.CPN_MEM_ID }"/></a>
			                           	</td>
			                          	<td>
                ...
                <form id="frmExcelDown">
                	<input type="hidden" name="CPN_MST_IDX"/>
                	<input type="hidden" name="MEM_IDX_ARR"/>
                </form>
...
$(function(){
	...
	$(document).on('click', '#excelDown', function() {
		...
		$('#frmExcelDown input[name="CPN_MST_IDX"]').val($('#CPN_MST_IDX').val());
		$('#frmExcelDown input[name="MEM_IDX_ARR"]').val(idxs);
		
		var $form = $('#frmExcelDown');
		$form.attr('action', '/am/marketing/onlineCouponIsuDetExcelDownload.do');

            ...
            <p><span><i class="require"><em>필수입력</em></i>업로드할 파일을 등록해 주세요.</span></p>
                ...
                <form name="excelForm" id="excelForm" enctype="multipart/form-data">
                    ...
                    <div class="text-right">
                    	<a href="javascript:;" class="button button-a sampleDownload" data-file_name="pointUploadSample.xls">샘플파일 다운로드</a>
        ...
        if($frm.valid())
        {
            ...
            else
            {
                ...
                ({
                    ...
                    processData: false,
                    contentType: false,
                    url : "<c:out value="${serverDomain}" />/am/marketing/pointMemberUploadAjax.do",

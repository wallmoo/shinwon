								...
								<c:choose>
			                       	<c:when test="${not empty detailList }">
										<c:forEach var="rowDetail" items="${detailList }" varStatus="i">
											<tr>
												...
												<td>
													<select class="select" name="PMT_CRD_SAL_GBN">
														<option value="">선택</option>
														<option value="R" <c:if test="${rowDetail.PMT_CRD_SAL_GBN eq 'R'}"> selected="selected" </c:if>>정율</option>
														<option value="M" <c:if test="${rowDetail.PMT_CRD_SAL_GBN eq 'M'}"> selected="selected" </c:if>>정액</option>	
													</select>
												</td>
												<td><input type="text" class="text number right" name="PMT_CRD_SAL_PRC" id="PMT_CRD_SAL_PRC<c:out value="${i.index }"/>" value="<fmt:formatNumber value="${rowDetail.PMT_CRD_SAL_PRC }" groupingUsed="true" />"/> 만원 / %</td>
												<td><input type="text" class="text number right" name="PMT_CRD_SML_PRC" id="PMT_CRD_SML_PRC<c:out value="${i.index }"/>" value="<fmt:formatNumber value="${rowDetail.PMT_CRD_SML_PRC }" groupingUsed="true" />"/> 만원</td>
												<td><input type="text" class="text number right" name="PMT_CRD_MXM_PRC" id="PMT_CRD_MXM_PRC<c:out value="${i.index }"/>" value="<fmt:formatNumber value="${rowDetail.PMT_CRD_MXM_PRC }" groupingUsed="true" />"/> 만원</td>
			                         ...
			                         <c:otherwise>
							          	<tr class="cardNodata"><!-- row -->
							               	<td colspan="8">행사 카드를 추가해 주세요.</td>
							            </tr>
							         </c:otherwise>
                        		</c:choose>
							</tbody>
...
<tr>
	...
	<td><input type="text" class="text number right" name="PMT_CRD_SAL_PRC" id="PMT_CRD_SAL_PRC\${NUM}" /> 만원 / %</td>
	<td><input type="text" class="text number right" name="PMT_CRD_SML_PRC" id="PMT_CRD_SML_PRC\${NUM}" /> 만원</td>
	<td><input type="text" class="text number right" name="PMT_CRD_MXM_PRC" id="PMT_CRD_MXM_PRC\${NUM}" /> 만원</td>

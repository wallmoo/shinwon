			  		...
			  		<table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
	                        ...
	                        <tr><!-- row -->
	                            ...
	                            <td>
	                            	<input type="text" class="text EXP_WIN_NM" id="EXP_WIN_NM" name="EXP_WIN_NM" style="width:80%;" maxlength="30"/>(<span id="byte_1">0</span><span>/30 byte)</span>
	                            </td>
	                        </tr>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<textarea class="textarea" name="EXP_WIN_MAN_CPY" id="EXP_WIN_MAN_CPY" style="width:80%; height: 100px;"></textarea>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<textarea class="textarea" name="EXP_WIN_SUB_CPY" id="EXP_WIN_SUB_CPY" style="width:80%; height: 100px;"></textarea>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<textarea class="textarea" name="EXP_WIN_ATN" id="EXP_WIN_ATN" style="width:80%; height: 100px;"></textarea>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<input type="radio" id="EXP_WIN_USE_YN1" class="radio" name="EXP_WIN_USE_YN" value="Y" checked="checked" />
									<label for="EXP_WIN_USE_YN1">사용</label>
									<input type="radio" id="EXP_WIN_USE_YN2" class="radio" name="EXP_WIN_USE_YN" value="N" />
...
//         		return;
       // 	}
        	if (confirm( "저장 하시겠습니까?")) {              	 
                $("#frm").attr({"action":"<c:out value="${serverDomain}" />/am/marketing/kingerWinRegist.do", "target":"_self", "method":"post"}).submit();
            }
        }
    });

                    ...
                    <table cellspacing="0" class="table-row table-a"><!-- table -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                	<input type="password" id="passOrg" class="text" maxlength="15" style="display:none;">
                            ...
                            <tr class="pwDiv">
                                ...
                                <td class="pwInputDiv">
                                    <input type="password" name="ADM_MST_PWD" id="ADM_MST_PWD" class="text" maxlength="15"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="ADM_MST_EMAIL_DOMAIN" id="ADM_MST_EMAIL_DOMAIN" value="<c:out value="${row.ADM_MST_EMAIL_DOMAIN }"/>" class="text" maxlength="30"/>
...
$(function(){  
	...
	fnRenderAdminComboBox = function(){
		var selVal = $('#AUT_MST_IDX option:selected').val();
		
		
        if(selVal == "${Code.VENDOR_ADMINISTRATOR_IDX}"){    // 입점업체관리자인 경우 입점업체 선택 있음
            $("#ADM_MST_SUB_IDX").show();
            $('#ADM_MST_D_SUB_IDX').hide();
            $(".erpNo").hide(); // 사번 숨김
        } else if (selVal == "${Code.VENDOR_STORE_ADMINISTRATOR_IDX}") {
        	$("#ADM_MST_SUB_IDX").show();
    ...
    var pwChecked = $('#pwdChange').is(':checked');
    // 폼체크
    $("#frm").validate({
        rules: {
    ...
    delPwTxt = function(){
        ...
        $(".pwInputDiv").append('<input type="password" name="ADM_MST_PWD" id="ADM_MST_PWD" class="text" maxlength="15"/> <small style="margin-left:10px;">영문, 숫자, 특수문자 포함 8~15자 입력</small>');
    };
    ...
    $(document).on("click", "#goRegist", function () {
        ...
        if($("#passOrg").val() != $("#ADM_MST_PWD").val()){

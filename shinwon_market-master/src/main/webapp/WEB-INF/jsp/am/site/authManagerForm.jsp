            ...
            <div class="container">
                ...
                <form id="frm" name="frm">
                    ...
                    <c:if test="${not empty menuList }">
                        <table cellspacing="0" class="table-col table-a is-td-valign-top menuList"><!-- table -->
                            <colgroup>
                                <col style="width: 15%; min-width: 180px;" />
                                <col style="width: 35%;" />
                                <col style="width: 15%; min-width: 180px;" />
                            ...
                            <tbody id="menuCheckList">
                                ...
                                <c:forEach var="row" items="${menuList }" varStatus="i">
                                    ...
                                    <c:if test="${row.ADM_MNU_LEVEL > 0 and row.ADM_MNU_LEVEL eq 1}">
                                        <li class="d1">
                                            <label><input type="checkbox" class="checkbox admin_mnu_depth2" name="ADM_ADM_MNU_IDX" value="<c:out value="${row.ADM_MNU_IDX }"/>" /><c:out value="${row.ADM_MNU_NM }"/></label>
                                    </c:if>
                                    <c:if test="${row.ADM_MNU_LEVEL > 0 and row.ADM_MNU_LEVEL eq 2}">
                                        <li class="d2">
                                            <label><input type="checkbox" class="checkbox admin_mnu_depth3" name="ADM_ADM_MNU_IDX" value="<c:out value="${row.ADM_MNU_IDX }"/>" /><c:out value="${row.ADM_MNU_NM }"/></label>    
                                    </c:if>

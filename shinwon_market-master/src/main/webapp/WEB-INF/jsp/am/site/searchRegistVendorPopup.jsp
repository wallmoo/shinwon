...
<div class="modal">
	<div class="modal-wrapper">
	    <div class="modal-inner">
                ...
                <h3 class="title"><span>입점사 검색</span></h3>
                ...
                <div class="section-button"><!-- section-button -->
                    <div class="wrap text-center">
                        <a href="#none" id="closePopup" class="button"><span>닫기</span></a>
                    </div>
                </div><!-- // section-button -->
...
$(document).ready(function () {
    ...
    search = function() 
    {
        ...
        $searchForm.attr({"action":"<c:out value="${serverDomain}" />/am/site/searchRegistVendorPopup.do", "target":"_self", "method":"post"}).submit(); 
    };
    ...
    goPage = function (cPage) 
    {
        ...
        $frm.attr({"action":"<c:out value="${serverDomain}"/>/am/site/searchRegistVendorPopup.do", "target":"_self", "method":"post"}).submit();
    };

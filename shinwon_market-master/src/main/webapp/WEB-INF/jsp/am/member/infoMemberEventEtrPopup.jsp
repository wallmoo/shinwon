	...
	<div class="modal-wrapper">
	    <div class="modal-inner">
            ...
            <div class="push-guide instant"><!-- push-guide -->
                <i class="icon"><!-- icon --></i>
                <h3 class="title"><span>참여내역</span></h3>
            </div><!-- // push-guide -->
            ...
            <table class="table-col table-a">
                ...
                <tbody>
                    <c:choose>
				    	...
				    	<c:set var="listNum" value="1" />
					    	<c:forEach var="item" items="${list }" varStatus="status">
								<tr>
									...
									<td><ui:formatDate value="${item.EVT_REG_DT }" pattern="yyyy-MM-dd hh:mm:ss"/></td>
									<td><c:out value="${item.ETR_CNT }" /></td>								
								</tr>
		    			...
		    			<c:otherwise>
					    	<tr>
								<td colspan="3" style="text-align:center;">이벤트 참여내역이 없습니다.</td>
							</tr>
		    			</c:otherwise>
					</c:choose>
                </tbody>

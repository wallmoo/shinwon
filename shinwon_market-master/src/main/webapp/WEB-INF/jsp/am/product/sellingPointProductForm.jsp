	...
	<div id="body"><!-- body -->
		...
		<section id="contents"><!-- contents -->
			...
			<div class="contents-inner"><!-- contents-inner -->
				...
				<h4 class="title">등록 (<strong class="strong">*</strong>는 필수 입력 사항입니다.)</h4>
				<!-- 
				<p>
                ...
                <form id="frm" name="frm"> 
                	...
                	<input type="hidden" name="PRM_WRD_POSITION" value="${Code.SELLING_POINT_FRONT }" />    
				...
				<div class="section-form"><!-- section-form-a -->
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="text" style="width: 87%;" id="PRM_WRD_TXT" name="PRM_WRD_TXT" maxlength="20" /> *최대 20자
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="text datepicker s-datepicker" id="PRM_WRD_ST_DT" name="PRM_WRD_ST_DT" value="" /> ~
							<input type="text" class="text datepicker e-datepicker" id="PRM_WRD_ED_DT" name="PRM_WRD_ED_DT" value="" />
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="radio" id="PRM_WRD_STATE1" class="radio" name="PRM_WRD_STATE" value="Y" checked="checked" />
							<label for="PRM_WRD_STATE1">사용</label>
							<input type="radio" id="PRM_WRD_STATE2" class="radio" name="PRM_WRD_STATE" value="N" />
						...
						<div class="field">
							...
							<div id="divCategory" class="hide"><!-- 카테고리 -->
								<div class="section-button"><!-- section button -->
									...
									<a href="<c:out value="${serverDomain}" />/am/product/searchCategoryPopup.do" class="button button-b small js-modal" data-width="600" data-height="300" data-scroll="true" target="_blank" title="새 창 으로 열립니다."><span>카테고리 추가</span></a>
								</div><!-- // section button -->
...
<tr>
    ...
    <td class="left">
		<a href="\${FRONT_URL}/pc/product/product.do?prdMstCd=\${PRD_MST_CD}&ADMIN=Y" target="_blank">\${PRD_MST_NM}</a>
	</td>
	<td>\${PRD_MST_CONSUMER_PRICE}</td>
    ...
    $(document).on("click", "#goRegist", function () 
    {
        ...
        if($frm.valid()){
            ...
            if (confirm( "저장 하시겠습니까?")) {               
                $("#frm").attr({"action":"<c:out value="${serverDomain}" />/am/product/sellingPointProductRegist.do", "target":"_self", "method":"post"}).submit();
            }
        }
    });
    ...
    fnResultProduct = function(params){
    	...
    	if( bCheck ){
    		...
    		$.each(params, function(index,item){
        		...
        		obj.PRD_MST_CONSUMER_PRICE 	= setComma(item.PRD_MST_NORMAL_PRICE);

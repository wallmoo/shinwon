...
<div id="container"><!-- container -->
    ...
    <div id="wrapper"><!-- wrapper -->
        ...
        <div class="container">
            ...
            <h2 class="title"><span>임직원 할인관리</span></h2>
...
search = function(){
    ...
    $searchForm.attr({"action":"<c:out value="${serverDomain}" />/am/product/empDiscountList.do", "target":"_self", "method":"post"}).submit(); 
};
	...
	$('#goRegist').on('click', function(){
		if(confirm('저장하시겠습니까?')) {
			...
			if(data.length <= 0) {
				...
				return false;
		 		var url = "<c:out value="${serverDomain}"/>/am/product/empDiscountRegist.do";

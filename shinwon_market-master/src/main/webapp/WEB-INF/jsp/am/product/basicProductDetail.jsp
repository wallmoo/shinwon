		...
		<div id="wrapper">
			...
			<div id="contents">
				...
				<div class="container">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<input type="text small" class="text date small" id="PRD_MST_FEE_ST_DT" name="PRD_MST_FEE_ST_DT" value="" readonly data-target-end="#PRD_MST_ICN_ED_DT">
									<span>~</span>
									<a href="javascript:;" class="js-datepickr"><span class="icon datepickr"><em>날짜선택</em></span></a>
									<input type="text small" class="text date small" id="PRD_MST_FEE_ED_DT" name="PRD_MST_FEE_ED_DT" value="" readonly data-target-start="#PRD_MST_ICN_ST_DT_">
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table-row table-a">
						<caption>전시정보의 일반가(Tag가), 할인율, 판메가, 수수료, 수수료 기간을 알 수 있는 표 입니다.</caption>
						<colgroup>
							<col style="width:15%;">
							<col style="width:35%;">
							<col style="width:15%;">
						...
						<tbody>
								...
								<td colspan="3">
									<div id="divCategory">
										<div class="text-right">
											<a href="#" id="goCategoryDelete_P" class="button button-a small"><span>선택삭제</span></a>
											<a id="goCategoryPopup" href="javascript:registPopup('P');" class="button button-b small" title="새 창 으로 열립니다."><span>카테고리 추가</span></a>
										</div>
							...
							<tr id="mobile_category">
								...
								<td colspan="3">
									<div id="divCategory">
										<div class="text-right">
											<a href="#" id="goCategoryDelete_M" class="button button-a small"><span>선택삭제</span></a>
											<a id="goCategoryPopup" href="javascript:registPopup('M');" class="button button-b small" title="새 창 으로 열립니다."><span>카테고리 추가</span></a>
										</div>
										<br>
										<table class="table-row table-a" id="tableCategory">
											<colgroup>

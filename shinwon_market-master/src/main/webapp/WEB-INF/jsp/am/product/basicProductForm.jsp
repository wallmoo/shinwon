			...
			<div id="contents">
				<div class="container">
					...
					<form id="searchForm" name="searchForm">
						...
						<input type="hidden" id="PRD_CTG_BRAND" name="PRD_CTG_BRAND">
					</form>
					...
					<form id="frm" name="frm" enctype="multipart/form-data">
						...
						<input type="hidden" id="product_image_env" name="product_image_env">
						<!-- 상품 이미지 순번 정보 - 팝업 등록에서 사용함 -->
						<input type="hidden" name="PRD_FILE_NAME" value="<c:out value="${commandMap.PRD_FILE_NAME }"/>">
						<!-- 상품 이미지 파일명 - 팝업 등록에서 사용함 -->
						<input type="hidden" id="pathType" name="pathType" value="product">
						<input type="hidden" id="CTG_PATH" name="CTG_PATH"> 
						<input type="hidden" name="PRD_MST_DLV_BND" value="0"> 
						...
						<input type="hidden" name="PRD_MST_ERP_TAG_NO"	id="PRD_MST_ERP_TAG_NO"> 
						
						<input type="hidden" name="PRD_MST_VDR_IDX" id="PRD_MST_VDR_IDX" value="${vdr_mast_idx}">
						<!-- <input type="hidden" name="PRD_MST_NFI_INF5" id="PRD_MST_NFI_INF5"> -->
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3"><input type="text" name="VDR_MST_NM"
										id="VDR_MST_NM" class="text" readonly> <span> /
									</span> <input type="text" name="BND_MST_BRAND_NM"
										id="BND_MST_BRAND_NM" class="text" readonly> <a
										href="javascript:;" id="" class="button button-a goBrandPopup"><span>조회</span></a>
								...
								<tr>
									...
									<td colspan="3">
										<div class="tbl_line">
											<select name="PRD_MST_TYPE" id="PRD_MST_TYPE"
												...
												<option value="B"
													<ui:select v="${productInfo.PRD_MST_TYPE}" t="B" g="selected"/>>묶음</option>
												<option value="S"
													<ui:select v="${productInfo.PRD_MST_TYPE}" t="S" g="selected"/>>세트</option>
											</select>
										</div>
										...
										<div class="S">
											<table class="table-row table-a mb0">
												...
												<tbody id="SPrdList" class="S">
													<tr>
														<td>
															<input id="set1_name" name="S_PRD_MST_NM" readonly class="text xlarge">
															<input type="hidden" name="S_PRD_MST_CD">
															<input type="hidden" name="S_PRD_MST_PRC">
															<input type="hidden" name="S_PRD_MST_SEL_CNT">
														</td>
														<td><a href="#" onclick="searchProductPopup('set1')" name=""class="button small"><span>상품찾기</span></a></td>
														<td><button type="button" class="btn_row_minus removeSProduct">-</button></td>
													</tr>
													<tr>
														<td>
															<input id="set2_name" name="S_PRD_MST_NM" readonly class="text xlarge">
															<input type="hidden" name="S_PRD_MST_CD"></input>
															<input type="hidden" name="S_PRD_MST_PRC"></input>
															<input type="hidden" name="S_PRD_MST_SEL_CNT"></input>
														</td>
									...
									<td class="B S">시스템 자동생성</td>
								</tr>
								
								<tr class="G">
									<th><label for="">상품품번<i class="require"><em>필수입력</em></i></label></th>
									<td colspan="3">
										<div class="tbl_line" id="prdCdManualLabel"	style="display: none;">
											<input type="text" name="txtErpProductStyleNo" class="text" id="txtErpProductStyleNo"> 
                                            <a href="javascript:fnReqErpProduct();" class="button small"><span>조회</span></a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="tbl_line G">
											<input type="text"	numberOnly name="PRD_MST_SEL_CNT" class="number text short" value="<fmt:formatNumber value="${productInfo.PRD_MST_SEL_CNT }"  groupingUsed="true" />"  maxlength="9" ${readonly_I_tag}/> 개
										</div>
										
										<p class="txt_warnning">(777 입력 시 수량 제한없음 처리)</p>
										<div class="B" id="BCntList"></div>
										
										<div class="S">
											<div class="tbl_line">
												<label for="">세트상품-1</label> <input type="text" name="S_PRD_MST_SEL_CNT"
													id="set1_quanity" class="text small"> <span> 개</span>
											</div>
											<div class="tbl_line">
												<label for="">세트상품-2</label> <input type="text" name="S_PRD_MST_SEL_CNT"
													id="set2_quanity" class="text small"> <span> 개</span>
											</div>
										</div>
								...
								<tr>
									...
									<td>
										<select name="PRD_MST_EMP_USE_YN"
										id="PRD_MST_EMP_USE_YN" class="select"
										<c:if test="${__MALL_ADMIN_SESSION_INFO__.AUT_MST_IDX eq Code.VENDOR_ADMINISTRATOR_IDX}">disabled</c:if>>
											<option value="N"
												<ui:select v="${productInfo.PRD_MST_EMP_USE_YN}" t="N" g="selected"/>>NO</option>
											<option value="Y"
												<ui:select v="${productInfo.PRD_MST_EMP_USE_YN}" t="Y" g="selected"/>>YES</option>
										</select>
									</td>
									<th>
									...
									<td><select name="PRD_MST_PRT_USE_YN"
										...
										<c:if test="${__MALL_ADMIN_SESSION_INFO__.AUT_MST_IDX eq Code.VENDOR_ADMINISTRATOR_IDX}">disabled</c:if>>
											<option value="N"
												<ui:select v="${productInfo.PRD_MST_PRT_USE_YN}" t="N" g="selected"/>>NO</option>
											<option value="Y"
												<ui:select v="${productInfo.PRD_MST_PRT_USE_YN}" t="Y" g="selected"/>>YES</option>
									</select></td>
								</tr>
								</c:if>
								<tr>
									...
									<td>
										<div class="tbl_line">
											<label for="">연도</label> <select class="select"
												name="PRD_MST_YEAR">
												<option value="" selected="selected">선택</option>
												<fmt:formatDate value="${now}" pattern="yyyy" var="thisYear" />
												<option id="${thisYear}"><c:out value="${thisYear}" /></option>
												<option id="${thisYear+1}"><c:out
														value="${thisYear+1}" /></option>
											</select>
										</div>
										<div class="tbl_line">
											<label for="">시즌</label> <select class="select"
												name="PRD_MST_SEASON">
												<option value="" selected="selected">선택</option>
								...
								<tr>
									<th><label for="">포장<i class="require"
											name="PRD_MST_PCK_USE_YN" id="PRD_MST_PCK_USE_YN"><em>필수입력</em></i></label></th>
									<td><select class="select">
											<option value="N">NO</option>
											<option value="Y">YES</option>
									</select></td>
									<th><label for="">배송비<i class="require"><em>필수입력</em></i></label></th>
									<td><input type="number" numberOnly name="PRD_MST_DLV_FEE" id="PRD_MST_DLV_FEE" class="text"></td>
								</tr>
															</tbody>
						</table>
						...
						<table class="table-row table-a">
							...
							<tbody>
								<tr>
									<th><label for="PRD_MST_PRC" >일반가(Tag가)<i
											class="require"><em>필수입력</em></i></label></th>
									<td><input type="text" numberOnly id="PRD_MST_PRC" name="PRD_MST_PRC"	class="text" value="<fmt:formatNumber value="${productInfo.PRD_MST_PRC }" groupingUsed="true" />"
										maxlength="9" /></td>
									<th><label for="">할인율<i class="require"><em>필수입력</em></i></label></th>
									<td><select name="PRD_MST_UNT" id="PRD_MST_UNT"
										class="select small">
											<option value="R" selected>정율(%)</option>
											<option value="S">정액(원)</option>
									</select> <input type="text" id="PRD_MST_SALE_RATE"
										name="PRD_MST_SALE_RATE" class="number text small"
										value="<fmt:formatNumber value="${productInfo.PRD_MST_CPR_PRC1 }" groupingUsed="true" />"
										maxlength="9"></td>
								</tr>
								<tr>
									<th><label for="">판매가</label></th>
									<td colspan="3"><input type="text" id="price" name=""
										class="text"
								...
								<tr>
									<th><span>수수료</span></th>
									<td><select name="PRD_MST_BRD_MRG_YN" 	id="PRD_MST_BRD_MRG_YN" class="select">
											<option value="Y">브랜드 기본마진</option>
											<option value="N">직접설정</option>
									</select>
									<input type="text" id="PRD_MST_FEE" name="PRD_MST_FEE" class="number text"  value="<fmt:formatNumber value="${productInfo.PRD_MST_SCH_PRC }" groupingUsed="true" />"	maxlength="9" disabled /> %</td>
									<th><span>수수료 기간</span></th>
										<td><a href="javascript:;" class="js-datepickr">
											<span class="icon datepickr"><em>날짜선택</em></span></a>
									<input type="text" class="text date small" id="PRD_MST_FEE_ST_DT" name="PRD_MST_FEE_ST_DT"	value="<c:out value="${PRD_MST_ICN_ST_DT[iconCnt -1]}" />"	readonly data-target-end="#PRD_MST_ICN_ED_DT${iconCnt}" /> ~
										<a href="javascript:;" class="js-datepickr">
										<span class="icon datepickr"><em>날짜선택</em></span>
										</a>
										<input	type="text" class="text date small" id="PRD_MST_FEE_ED_DT"	name="PRD_MST_FEE_ED_DT"	value="<c:out value="${PRD_MST_ICN_ED_DT[iconCnt -1] }" />"	readonly data-target-start="#PRD_MST_ICN_ST_DT_${iconCnt}" />
									</td>
								</tr>
								</c:if>
							</tbody>
								...
								<tr>
									...
									<td>
										...
										<div class="tag_cloud_wrap_side">
											...
											<button type="button" class="btn_tag_select" onclick="submitTag()">선택</button>
										</div>
									</td>
								</tr>
								<tr>
									<th><label for="">대표 TAG<i class="require"><em>필수입력</em></i></label></th>
									<td><select name="" id="representTag" class="select">
						...
						<table class="table-row table-a">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<select class="select" id="PRD_MST_APV_STATE" name="PRD_MST_APV_STATE" <c:if test="${not empty vendorManagerInfo}">disabled style="display:none" </c:if>>
									...
									<td colspan="3">
										<div id="divCategory">
											<div class="text-right">
												<a href="#" id="goCategoryDelete_${Code.CATEGORY_TYPE_PC}"
														...
														<c:when test="${not empty categoryListP}">
															<c:forEach var="item" items="${categoryListP }" varStatus="status">
																<tr>
																	...
																	<td class="left">
																		<label for="PRD_CTG_IDX_${item.DSP_CTG_IDX}"><c:out value="${item.PRD_CTG_PATH }" /></label>
																	</td>
																</tr>
															</c:forEach>
														</c:when>
						...
						<h3 class="title color_info_cls"><span>색상정보</span></h3>
								...
								<tr>
									...
									<td colspan="3">
										<div class="color_info_wrap_side">
											<div class="color_info_wrap cf">
												<ul class="color_list">
													<c:forEach var="item" items="${colorList}" varStatus="i">
														<li><input type="checkbox" name="CMN_COM_ETC2"	id="color_<c:out value="${item.CMN_COM_NM}"/>"	value="<c:out value="${item.CMN_COM_IDX}"/>"
											...
											<button type="button" class="btn_color_select" id="addColor">선택</button>
										</div>
									</td>
								</tr>
								<tr>
						...
						<div id="tab1">
							...
							<ul class="form_radio_check_list">
								<li><input type="radio" class="radio" id="radio1"
									name="PRD_MST_IMG_RATE" value="R" checked> <label
									for="radio1">2:3비율 노출</label></li>
								<li><input type="radio" class="radio" id="radio2"
									name="PRD_MST_IMG_RATE" value="S"> <label for="radio2">정비율
										노출</label></li>
							</ul>
										...
										<table class="table-row table-a productImgUrl">
											...
											<tbody>
												...
												<tr>
													...
													<td class="left" id="urlImageContainer">
														<div class="tbl_line">
		...
		<table class="table-col table-c" id="optDetail_\${OPT_IDX}">
			...
			<tbody>
				<tr style="margin:0px; padding:0px;">
					...
					<td>
						<input type="text" class="numbernr text" name="OPT_DTL_ADD_PRC" id="O
PT_DTL_ADD_PRC" maxlength="9" style="width:80px;" />
					</td>
					<td>
...
<tr>
<td>
	<button type="button" class="btn_row_minus removeColor" value="\${code}">-</button>
	...
	<table class="tbl_color">
		<colgroup>
			...
			<tbody>
				<tr>
					<td>
						<select name="" id="" class="select CMM_OPT_NM">
							<option value="" selected="selected">선택</option>
							<c:forEach var="row" items="${sizeList}">
								<option value="${row.CMN_COM_IDX}">${row.CMN_COM_NM}</option>
							</c:forEach>
						</select>
						<button type="button" class="btn_row_plus addSize">+</button>
					</td>
					<td>
						<input type="text" id="" class="text number xlarge OPT_STK_CNT" value="">
					</td>
					<td>
						<select id="" class="select xlarge CMM_OPT_USE_YN">
							<option value="Y" selected>사용</option>
							<option value="N">미사용</option>
						</select>
					</td>
					<td>
						<input type="text" id="" class="text xlarge CMM_OPT_HW">
					</td>
				</tr>
			</tbody>
		</table>
...
<tr>
	<td>
		...
		<!--<input type="text" name="" id="" class="text number CMM_OPT_NM" value="" place-holder="사이즈입력">-->
		<button type="button" class="btn_row_minus removeSize">-</button>
	</td>
	<td>
		<input type="text" name="" id="" class="text number xlarge OPT_STK_CNT" value="" place-holder="재고입력">
	</td>
	<td>
		<select name="" id="" class="select xlarge CMM_OPT_USE_YN">
			<option value="Y" selected>사용</option>
			<option value="N">미사용</option>		
		</select>
	</td>
	<td>
		<input type="text" name="" id="" class="text xlarge CMM_OPT_HW">
	</td>
</tr>
</script>
...
<tr>
	<td>
		<input type="hidden" name="B_PRD_MST_CD" value="\${PRD_MST_CD}">
		<input type="hidden" name="B_PRD_MST_SEL_CNT" value="\${PRD_MST_SEL_CNT}">
		<input type="hidden" name="B_PRD_MST_PRC" value="\${PRD_MST_PRC}">
		<input class="text xlarge" name="B_PRD_MST_NM" readonly value="\${PRD_MST_NM}">
	</td>
...
<script type="text/template" id="BCntTemplate">
	...
	<script>
		...
		$(function() {
			...
			$(document).on("click",	"#goRegist",function() {
								...
								if ($("select[name=PRD_MST_YEAR] option:selected").val() == ""|| $(	"select[name=PRD_MST_SEASON] option:selected").val() == "") {
									alert("시즌정보를 입력해주세요.");
									$("select[name=PRD_MST_SEASON]").focus();
									return;
								}
								...
								if ($("input[name=PRD_MST_DLV_FEE]").val() == "") {
									alert("배송비를 입력해 주세요.");
								...
								/* if ($("#PRD_MST_CNL_MB_YN").is(":checked")) {
								 ...
								 if ($("input[name=PRD_CTG_IDXs_${Code.CATEGORY_TYPE_PC}]").length == 0) {
									...
									$(".button.button-b.small").focus();
									return;
								}
								
								
								/* 	if ($("input[name=PRD_CTG_IDXs_${PRD_CTG_ENV}]").length == 0 ) {
										alert("색상을 선택해주세요.");
										$(".color_list_box").focus();
										return;
								} */	
								
									/* if ($("#mustOptionData").length == 0 ) {
										alert("색상을 선택해주세요.");
										$(".color_list_box").focus();
										return;
								}	 */
			...
			$(document)
					.on(
							...
							function() {
								...
								if (!prdNfiChk) {
									fnResultBrand($("#PRD_MST_BRD_IDX").val(), $("#PRD_MST_BRD_NM").val(), $("#PRD_MST_BRD_SERV").val(), $("#PRD_MST_VDR_IDX").val(), $("#VDR_MST_NM").val()); //AS전화번호
			...
			//브랜드 선택 함수
			fnResultBrand = function(brdMstIdx, brdMstNm, brdMstServ, vdrMstIdx, vdrMstNm, brdType) {
				...
				if (brdMstIdx != "") {
					...
					$("#PRD_MST_VDR_IDX").val(vdrMstIdx);
					$("#VDR_MST_NM").val(vdrMstNm);
					$("#BND_MST_BRAND_NM").val(brdMstNm);
					if (brdType == '${Code.BND_MST_BRAND_TYPE_O}') {
						$('#prdCdManualLabel').attr('style', 'display:none;');
						$('#prdCdAutoLabel').removeAttr('style');
					} else if (brdType == '${Code.BND_MST_BRAND_TYPE_I}') {
						$('#prdCdManualLabel').removeAttr('style')
						$('#prdCdAutoLabel').attr('style', 'display:none;');
					}
		...
		$(document).ready(function() {
			<c:if test="${not empty brandManagerInfo and not empty vendorManagerInfo }">
				fnResultBrand('<c:out value="${brandManagerInfo.BND_MST_IDX}" />', '<c:out value="${brandManagerInfo.BND_MST_SEL_NM}" />', '<c:out value="${brandManagerInfo.BND_MST_SERV}" />', '<c:out value="${vendorManagerInfo.VDR_MST_IDX}" />', '<c:out value="${vendorManagerInfo.VDR_MST_MNG_NM}" />','<c:out value="${brandManagerInfo.BND_MST_BRAND_TYPE}" />');
			</c:if>
		...
		$(document).on("click",	"#addColor", function() {
			...
			let checkedColorBoxList = $(".color_list_box:checked");
			...
			checkedColorBoxList.each(function() {
				...
				let finded = $(".tbl_color_list").find(	".btn_row_minus[value=" + obj.code + "]");
				if (finded.length < 1) {
					params.push(obj);
				}
			});

			checkedColorBoxList.attr("checked", false);
			$("#colorTemplate").tmpl(params).appendTo(".tbl_color_list");
			return true;
		});
		...
		$(document).on(
				...
				function() {
					...
					$("#sizeTemplate").tmpl(params).appendTo(
		...
		/* 	//상품 중복체크
		 ...
		 var bReturn = true;
		 var $obj = $(".matchProductList").find(".PRD_MST_RLT_CD");
		 $.each($obj, function(){
		...
		$(document).on("change", "#PRD_MST_TYPE", function() {
			$(".G").hide();
			$(".B").hide();
			$(".S").hide();

			if ($(this).find("option:selected").val() == "G") {
				$(this).parents('td').attr('colspan','3');
				$(".G").show();
				$('.color_info_cls').show();
			} else if ($(this).find("option:selected").val() == "B") {
				$(this).parents('td').removeAttr('colspan');
				$(".B").show();
				$('.color_info_cls').hide();
			} else {
				$(this).parents('td').removeAttr('colspan');
		...
		//상품팝업 상품선택시 호출되는 메소드
		fnResultProductCode = function(params) {
			...
			var obj;
			if (bCheck) {
				$("input[name=" + curId + "]").val(prdMstIdx);
				$("input[name=" + curId + "]").prev().val(prdMstNm);
			}
			return true;
		};
		...
		fnDuplicationChk = function(selectObj) {
			var bReturn = true;
			$("#BPrdList input[name=B_PRD_MST_CD]").each(function() {
				if (selectObj == $(this).val()) {
					bReturn = false;
					return false;
				}
		...
		$(document).on("click", ".removeSProduct", function() {
			var $trElem = $(this).closest('tr');
			 $('input[name=S_PRD_MST_NM]', $trElem).val('');
			 $('input[name=S_PRD_MST_CD]', $trElem).val('');
			 $('input[name=S_PRD_MST_PRC]', $trElem).val('');
			 $('input[name=S_PRD_MST_SEL_CNT]', $trElem).val('');
			 
			fnCalTotalPrice('set');
			fnRenderQuantityUI('set');
		});

		fnReqErpProduct = function() {
			var styleNo = $('#txtErpProductStyleNo').val();
			if (styleNo == undefined || styleNo == null || styleNo == "") {
				alert("검색 필드는 필수 입력입니다.");
				$('.txtErpProductStyleNo').focus();
				return;
			}
			...
			$
					.ajax({
						...
						url : "<c:out value="${serverDomain}" />/am/erp/productDataAjax.do",
						success : function(data) {
							...
							fnBindProductMaster(data.productMaster, data.productDetail);
						},
						error : function(err) {
		...
		fnInitProductMaster = function() {
			
		}
		fnBindProductMaster = function(productMasterData, productDetailData) {
			if (productMasterData == null || productMasterData == undefined || productMasterData.length < 1) {
				return;
			}
			
			$("input[name='PRD_MST_NM']").val(productMasterData[0].PROD_NAME);
			$("input[name='PRD_MST_YEAR']").val(productMasterData[0].SEASON_YEAR);
			$("input[name='PRD_MST_SEASON']").val(productMasterData[0].SEASON);
			$("input[name='PRD_MST_PRC']").val(productMasterData[0].TAG_PRICE);
			//$("input[name='PRD_MST_NFI_INF5']").val(productMasterData[0].PROD_NATION);
			$("input[name='PRD_MST_ERP_CD']").val(productMasterData[0].STYLE_NO);
			$("input[name='PRD_MST_ERP_TAG_NO']").val(productMasterData[0].TAG_STYLE_NO);
			
			$(".tbl_color_list").empty();
			let colorOptions = [];
			for (var index = 0; index < productMasterData.length; index++) {

				let color = {
					code : $("#color_" + productMasterData[index].COLOR_CODE).attr("value"),
					Color : $("#color_" + productMasterData[index].COLOR_CODE).next().attr("id")
				};
				
				if (colorOptions.findIndex(function(item) {	return item.code == color.code }) == -1) {
					colorOptions.push(color);
					$("#colorTemplate").tmpl(color).appendTo(".tbl_color_list");
					let selectTag = $(".tbl_color_list table.tbl_color select.CMM_OPT_NM").last(); 
					var finedOption = selectTag.find("option:contains('"+productMasterData[index].SIZE_CODE+"')");
					if(finedOption != undefined && finedOption != null && finedOption.length>0){
						finedOption[0].setAttribute("selected", "selected");
						selectTag.attr("readonly", "readonly");
					}
					if(productMasterData[index].STOCK_QTY != undefined && productMasterData[index].STOCK_QTY != null){
						let stockInput = $(".tbl_color_list table.tbl_color input.OPT_STK_CNT").last();
						stockInput.val(productMasterData[index].STOCK_QTY);
						stockInput.attr("readonly", "readonly");
					}
					
				} else {
					$("#sizeTemplate").tmpl().appendTo($(".tbl_color_list table.tbl_color"));
					let selectTag = $(".tbl_color_list table.tbl_color select.CMM_OPT_NM").last(); 
					let finedOption = selectTag.find("option:contains('"+productMasterData[index].SIZE_CODE+"')");
					if(finedOption != undefined && finedOption != null && finedOption.length>0){
						finedOption[0].setAttribute("selected", "selected");
						selectTag.attr("readonly", "readonly");
					}
		...
		fnSetProductMasterReadOnly = function(readonly) {
			$("input[name='PRD_MST_NM']").attr("readonly", readonly);
			$("input[name='PRD_MST_YEAR']").attr("readonly", readonly);
			$("input[name='PRD_MST_SEASON']").attr("readonly", readonly);
			$("input[name='PRD_MST_PRC']").attr("readonly", readonly);
		}
	//-->
	</script>
<script>

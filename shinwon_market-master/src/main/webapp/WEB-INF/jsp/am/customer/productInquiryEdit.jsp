                    ...
                    <table cellspacing="0" class="table-row table-a"><!-- table -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="textarea xlarge" name="BRD_INQ_REPLY_CONTENTS" id="BRD_INQ_REPLY_CONTENTS" style="height: 500px; width:80%;"><c:out value="${row.BRD_INQ_REPLY_CONTENTS }"/></textarea>
                                </td>
                            </tr>
...
$(function(){
    ...
    $(document).on("click", "#goRegist", function () {
        ...
        if($frm.valid())
        {
            ...
            {
                $frm.attr({"action":"<c:out value="${serverDomain}"/>/am/board/productInquiryModify.do", "target":"_self", "method":"post"}).submit();
            }
        }
    });

                ...
                <div class="section-form"><!-- section-form-a -->
                    <form name="frm" id="frm">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="field">
	                            <input type="text" name="CMN_ANS_TITLE" class="text long" name="CMN_ANS_TITLE" id="CNM_ANS" maxlength="50"/>
	                        </div>
	                    </div>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="field">
	                            <textarea class="textarea" name="CMN_ANS_CONTENTS" id="CMN_ANS_CONTENTS" style="height: 500px;"></textarea>
	                        </div>
	                    </div>
                    </form>
                </div><!-- // section-form-a -->
    ...
    $(document).on("click", "#goRegist", function () {
        ...
        if($frm.valid()){
            ...
            if (confirm( "저장 하시겠습니까?")) {
                $frm.attr({"action":"<c:out value="${serverDomain}"/>/am/board/oftenReplyRegist.do", "target":"_self", "method":"post"}).submit();
            }
        }
    });

		  						...
		  						<div class="section-form"><!-- section-form-a -->
		              				<input type="hidden" name="groupNum" class="groupNum" value="<c:out value="${prdGrpRow.EML_GRP_SEQ }" />"/>
		                       		<div class="form-group">                
										...
										<div class="field">
											<input type="text" name="EML_GRP_NM<c:out value="${prdGrpRow.EML_GRP_SEQ }" />" value="<c:out value="${prdGrpRow.EML_GRP_NM }" />" class="text PLN_GRP_TITLE long" data-rnum="0" maxlength="66"/>
										</div>
		                       		</div>

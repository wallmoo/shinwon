        ...
        <section id="contents"><!-- contents -->
            ...
            <div class="contents-inner"><!-- contents-inner -->
   				...
   				<div id="contentBoxList">
    				<div id="contentBox">
  						<div class="section-form"><!-- section-form-a -->
              				<input type="hidden" name="conGroupNum" class="conGroupNum" value="0"/>
												...
												<tr><!-- row -->
	                               					<td>
	                               						<table style="width: 100%;" >
	                               							<tbody>
	                               								<tr>
	                               									<td><input type="file" name="fileCon_up_0" id="fileCon[0]" class="file" value="" /></td>
	                               								</tr>
	                               								<tr>
	                               									<td class="left">제목 : <input type="text" name="EML_CTS_NM_UP_0" id="EML_CTS_NM_UP_0" class="text"  style="width: 60%;" maxlength="100" /></td>
	                               								</tr>
	                               								<tr>
	                               									<td class="left">링크 : <input type="text" name="EML_CTS_LNK_UP_0" id="EML_CTS_LNK_UP_0" class="text"  style="width: 60%;" maxlength="100" /></td>
	                               								</tr>
	                               							</tbody>
	                               						</table>
	                               					</td>
	                           					...
	                           					<tr><!-- row -->
	                               					<td>
	                               						<table style="width: 100%;">
	                               							<tr>
                               									<td style="border:0px;"><input type="file" name="fileCon_dn_0" id="fileCon[1]" class="file" value="" /></td>
                               								</tr>
                               								<tr>
                               									<td style="border:0px;" class="left">제목 : <input type="text" name="EML_CTS_NM_DN_0" id="EML_CTS_NM_DN_0" class="text"  style="width: 60%;" maxlength="100" /></td>
                               								</tr>
                               								<tr>
                               									<td style="border:0px;" class="left">링크 : <input type="text" name="EML_CTS_LNK_DN_0" id="EML_CTS_LNK_DN_0" class="text"  style="width: 60%;" maxlength="100" /></td>
                               								</tr>
	                               						</table>
	                               					</td>
	                           					</tr>
														...
														<table id="fileViewPrd" style="width:100%;">
							                    			<tr>	                    				
							                    				<td id="defaultFile">	                    					
							                    					...
							                    					<br><br>URL&nbsp;&nbsp;<input type="text" name="EML_LNK_ONE_URLs" id="EML_LNK_ONE_URLs" class="text"  style="width: 60%;" maxlength="100" />	                    						                    					                   					 					               		
							                    				</td>	
							                    			</tr>
							                    		</table>
													</td>
												...
												<tr>
													<td>
														<table id="fileViewOneBnr" style="width:100%;">
							                    			<tr>	                    				
							                    				<td id="defaultFile">	                    					
							                    					<input type="file" name="fileOneBnr_0" id="filesOneBnr[0]" class="file" value="" />
							                    					<br><br>URL&nbsp;&nbsp;<input type="text" name="EML_ONE_BNRLNK_URLs" id="EML_ONE_BNRLNK_URLs" class="text"  style="width: 60%;" maxlength="100" />	                    						                    					                   					 					               		
							                    				</td>	
							                    				<td>
							                    					<input type="button" name="addFileOneBnr" id="addFileOneBnr"  data-file_idx="0" value="+"/>
							                    				</td>
							                    			</tr>
							                    		</table>
													</td>
    				...
    				<div id="productBox">
  						<div class="section-form"><!-- section-form-a -->
              				...
              				<div class="form-group">                
								...
								<div class="field">
									<input type="text" name="EML_GRP_NM_1_0" class="text PLN_GRP_TITLE long" data-rnum="0" maxlength="66"/>
								</div>
                       		</div>
												...
												<tr>
													<td>
														<table id="fileViewPrd" style="width:100%;">
							                    			<tr>	                    				
							                    				<td id="defaultFile">	                    					
							                    					<input type="file" name="filePrd_0" id="filesPrd_0[0]" class="file" value="" />
							                    					<br><br>URL&nbsp;&nbsp;<input type="text" name="PRD_BNR_LNK_URL_0" id="PRD_BNR_LNK_URL_0" class="text"  style="width: 60%;" maxlength="100" />	                    						                    					                   					 					               		
							                    				</td>	
							                    				<td>
							                    					<input type="button" name="addFilePrd" id="addFilePrd" data-file_idx="0" value="+"/>
							                    				</td>
							                    			</tr>
							                    		</table>
													</td>
				...
				<div id="productBoxList2">
    				<div id="productBox2">
  						<div class="section-form"><!-- section-form-a -->
              				<input type="hidden" name="groupNum2" class="groupNum2" value="0"/>
                       		<div class="form-group">                
								<label class="label"><span>그룹명<em class="strong">*</em></span></label>
								<div class="field">
									<input type="text" name="EML_GRP_NM_2_0" class="text PLN_GRP_TITLE long" data-rnum="0" maxlength="66"/>
								</div>
                       		</div>
                       		<div class="form-group">
												...
												<tr>
													<td>
														<table id="fileViewPrd2" style="width:100%;">
							                    			<tr>	                    				
							                    				<td id="defaultFile2">	                    					
							                    					<input type="file" name="filePrd2_0" id="filesPrd2_0[0]" class="file" value="" />
							                    					<br><br>URL&nbsp;&nbsp;<input type="text" name="PRD_BNR_LNK_URL2_0" id="PRD_BNR_LNK_URL2_0" class="text"  style="width: 60%;" maxlength="100" />	                    						                    					                   					 					               		
							                    				</td>	
							                    			</tr>
							                    		</table>
													</td>
				...
				<div class="title-box">
   				...
   				<div id="planBoxList">
    				<div id="planBox">
  						<div class="section-form"><!-- section-form-a -->
              				<input type="hidden" name="planGroupNum" class="planGroupNum" value="0"/>
												...
												<tr><!-- row -->
	                               					<td>
	                               						<table style="width: 100%;" >
	                               							<tbody>
	                               								<tr>
	                               									<td><input type="file" name="filePlan_0" id="filePlan[0]" class="file" value="" /></td>
	                               								</tr>
	                               								<tr>
	                               									<td class="left">제목 : <input type="text" name="EML_PLN_TITLE_0" id="EML_PLN_TITLE_0" class="text"  style="width: 60%;" maxlength="100" /></td>
	                               								</tr>
	                               								<tr>
	                               									<td class="left">링크 : <input type="text" name="EML_PLN_LNK_0" id="EML_PLN_LNK_0" class="text"  style="width: 60%;" maxlength="100" /></td>
	                               								</tr>
	                               							</tbody>
	                               						</table>
	                               					</td>
	                           					...
	                           					<tr><!-- row -->
	                               					<td>
	                               						<table style="width: 100%;">
	                               							<tr>
                               									<td style="border:0px;"><input type="file" name="filePlan_0" id="filePlan[1]" class="file" value="" /></td>
                               								</tr>
                               								<tr>
                               									<td style="border:0px;" class="left">제목 : <input type="text" name="EML_PLN_TITLE_0" id="EML_PLN_TITLE_0" class="text"  style="width: 60%;" maxlength="100" /></td>
                               								</tr>
                               								<tr>
                               									<td style="border:0px;" class="left">링크 : <input type="text" name="EML_PLN_LNK_0" id="EML_PLN_LNK_0" class="text"  style="width: 60%;" maxlength="100" /></td>
                               								</tr>
	                               						</table>
	                               					</td>
	                           					</tr>
				...
				<tbody>
					<tr><!-- row -->
						<td>
							<table style="width: 100%;" >
								<tbody>
									<tr>
										<td><input type="file" name="fileCon_up_\${NUM}" id="fileCon[0]" class="file" value="" /></td>
									</tr>
									<tr>
					...
					<tr><!-- row -->
						<td>
							<table style="width: 100%;">
								<tr>
									<td style="border:0px;"><input type="file" name="fileCon_dn_\${NUM}" id="fileCon[1]" class="file" value="" /></td>
								</tr>
								<tr>
				...
				<tbody>
					<tr><!-- row -->
						<td>
							<table style="width: 100%;" >
								<tbody>
									<tr>
										<td><input type="file" name="filePlan_\${NUM}" id="filePlan[0]" class="file" value="" /></td>
									</tr>
									<tr>
					...
					<tr><!-- row -->
						<td>
							<table style="width: 100%;">
								<tr>
									<td style="border:0px;"><input type="file" name="filePlan_\${NUM}" id="filePlan[1]" class="file" value="" /></td>
								</tr>
								<tr>
...
$(document).ready(function () {
    ...
    $(document).on("click","#addFilePrd", function(){
    	...
    	if(fileLen == 10){
    		...
    		var fileHtml = "";
	    	fileHtml = fileHtml + '<tr><td>' + '<input type="file" class="file" name="filePrd_'+fileIdx+'" id="filePrd_'+fileIdx+'['+ fileNum +']"/>' + '<br><br>URL&nbsp;&nbsp;<input type="text" name="PRD_BNR_LNK_URL_'+fileIdx+'" id="PRD_BNR_LNK_URL_'+fileIdx+'" class="text"  style="width: 60%;" maxlength="100" /></td><td>'+'<input type="button" onClick="rowDelete(this)" value="-"/>'+'</td></tr>';
    ...
    $("#addFileOneBnr").click(function(){
    	...
    	if(fileLen == 10){
	    	...
	    	var fileHtml = "";
	    	fileHtml = fileHtml + '<tr><td>' + '<input type="file" class="file" name="fileOneBnr_'+fileLen+'" id="fileOneBnr['+ fileNum +']"/>' + '<br><br>URL&nbsp;&nbsp;<input type="text" name="EML_ONE_BNRLNK_URLs" id="EML_ONE_BNRLNK_URLs" class="text"  style="width: 60%;" maxlength="100" /></td><td>'+'<input type="button" onClick="rowDelete(this)" value="-"/>'+'</td></tr>';
        ...
        if($frm.valid()){
			...
			$("input[name^=EML_GRP_NM_2]").each(function(){
            	...
            	if($("input[name='EML_GRP_NM_2_"+rnum+"']").val()=="")
       		 	{
                   groupFoduc = $("input[name='EML_GRP_NM_2_"+rnum+"']");
                   groupCheck = false;
                   return false;
				}
            });
        	...
        	$(".applyProductList2").each(function(){
           		if($(this).find(".checkRow2").length <= 0)
                {
           		...
           		if($(this).find(".checkRow2").length % 5 != 0){
       				prdCntChk = false;
       				prdCntChkAtr = "[상품구성(이미지1+상품5개)]은 상품은 5개로로 구성되어야 합니다.";
       				return false;
       			}
            });
    ...
    function addPlanGroup()
    {
        ...
        {
            var obj = new Object();
            obj.NUM = contentGroupCheck(0, "min", "Y") ? i : $planBox.find(".section-form").length;
            arrayObj.push(obj);    
        }

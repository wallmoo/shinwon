		...
		<div class="container"><!-- container -->
			<div class="wrap gutter event-board"><!-- wrap -->
				...
				<div class="section-comment"><!-- section-comment -->
					...
					<form name="boardFrm" id="boardFrm" enctype="multipart/form-data">
						...
						<div class="grid comment-content fields"><!-- comment-content -->
						    ...
						    <p class="reset col-2-3">
						        <textarea class="textarea xlarge" id="EVT_BOARD_CONTENTS" name="EVT_BOARD_CONTENTS" maxlength="500"></textarea>
						    </p>
						</div><!-- // comment-content -->
					</form>
				</div><!-- // section-comment -->
				...
				<div class="grid section-button actions"><!-- section-button -->
				    ...
				    <div class="col-1-2">
				        <a href="javascript:;" id="goRegist" class="button warning full">
				            <span>등록</span>
				        </a>
				    </div>
				</div><!-- // section-button -->
	...
	$(function(){
		...
		$(document).on("click","#goRegist",function()
		{
			...
			if (confirm( "등록하시겠습니까?"))
            {
				...
				$boardFrm.attr("action", "<c:out value="${mobileDomain}"/>/mobile/customer/boardEventInsert.do");

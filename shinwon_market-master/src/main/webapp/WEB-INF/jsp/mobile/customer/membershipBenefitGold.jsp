			...
			<div class="wrap membership-wrap"><!-- warp -->
			    ...
			    <div class="tab-b item-3"><!-- tab-b -->
				    <ul class="tab">
				        ...
				        <li><a href="<c:out value="${mobileDomain}" />/mobile/customer/membershipBenefitSilver.do"><span>실버등급</span></a></li>
				        <li class="active"><a href="javascript:;"><span>골드등급</span></a></li>
				    </ul>
				</div><!-- // tab-b -->

				<div class="memeber-class">
				    <span class="icon gold"><em>골드등급</em></span>
				</div>

				<h4 class="title"><span>골드등급 혜택안내</span></h4>

				<div class="gap"><!-- gap -->
				    <ul class="basic"> 
				        <li><span class="warning">누적포인트 250,001점 이상인 회원</span></li>
				        <li>골드회원을 위한 분기별 추가 할인권 발송</li>

...
$(function(){
    ...
    search = function() 
    {
        ...
        $searchForm.attr({"action":"<c:out value="${mobileSslDomain}" />/mobile/mypage/gestOrderCancelBackList.do", "target":"_self", "method":"get"}).submit(); 
    };
    ...
    goPage = function (cPage) 
    {
        ...
        $frm.attr({"action":"<c:out value="${mobileSslDomain}"/>/mobile/mypage/gestOrderCancelBackList.do", "target":"_self", "method":"get"}).submit();
    };

...
<section id="wrap">
    ...
    <article id="container" class="container" data-role="content">
        ...
        <div class="tab-a" data-role="navbar"><!-- tab-a -->
            <ul>
                <li class="active"><a href="javascript:callJavascriptLoginUrl('<c:out value="${mobileSslDomain}"/>/mobile/mypage/myShoppingList.do','_self');" target="_self">쇼핑몰 주문내역</a><span class="blind">현재위치</span></li>

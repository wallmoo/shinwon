	...
	<section id="wrap">
		...
		<article id="container" class="container" data-role="content">
	        ...
	        <ul class="form-a qna-write"><!-- form-a -->
	            ...
	            <li class="tel">
	                ...
	                <div class="field">
	                    ...
	                    <input type="text" class="text number" maxlength="4" name="MEM_ADV_HP2" id="MEM_ADV_HP2" title="휴대폰 번호 중간자리" value="<c:out value="${row.MEM_ADV_HP2 }" />"> -
	                    <input type="text" class="text number" maxlength="4" name="MEM_ADV_HP3" id="MEM_ADV_HP3" title="휴대폰 번호 끝자리" value="<c:out value="${row.MEM_ADV_HP3 }" />">
	                    <p class="desc">
	                        <input type="checkbox" id="MEM_ADV_MBL_YN" name="MEM_ADV_MBL_YN" value="Y" class="checkbox" <ui:select v="${row.MEM_ADV_MBL_YN}" t="Y" g="checked"/>>
	            ...
	            <li class="mail">
	                ...
	                <div class="field">
	                    <p>
	                        ...
	                        <input type="text" id="MEM_ADV_MAIL_ID" name="MEM_ADV_MAIL_ID" class="text" title="이메일 아이디" maxlength="20" data-err_msg_id="memEmailId" value="<c:out value="${emailary[0] }" />"> @
	                        <input type="text" class="text" title="이메일 도메인" id="MEM_ADV_MAIL_DOMAIN" name="MEM_ADV_MAIL_DOMAIN" data-err_msg_id="memEmailDomain" value="<c:out value="${emailary[1] }" />">
	                    </p>
	                    <p>
	                        ...
	                        <select id="MEM_ADV_QST_TYPE_UP" name="MEM_ADV_QST_TYPE_UP" class="select" title="문의유형 첫번째 카테고리">
								...
								<c:if test="${not empty inqTypeCodeList }">
								    <c:forEach var="inqTypeCodeRow" items="${inqTypeCodeList }" varStatus="i" >
								        <option value="<c:out value="${inqTypeCodeRow.CMN_COM_IDX }"/>" <ui:select v="${row.MEM_ADV_QST_TYPE_UP}" t="${inqTypeCodeRow.CMN_COM_IDX }" g="selected"/>>
	            ...
	            <li class="search">
	                ...
	                <div class="field">
	                    <input type="text" id="ORD_MST_CD" name="ORD_MST_CD" class="text" disabled=true value="<c:out value="${row.ORD_MST_CD }" />">
	            ...
	            <li class="search">
	                ...
	                <div class="field">
	                    <input type="text" id="MEM_ADV_MDL_NO" name="MEM_ADV_MDL_NO" class="text" disabled=true value="<c:out value="${row.MEM_ADV_MDL_NO }" />">
	            ...
	            <li class="subject">
	                ...
	                <div class="field">
	                    <input type="text" id="MEM_ADV_TITLE" name="MEM_ADV_TITLE" class="text" value="<c:out value="${row.MEM_ADV_TITLE }" />">
	                </div>
	            </li>
	            <li class="message">
	                <div class="tit">
	                ...
	                <div class="field">
	                    <textarea class="textarea" id="MEM_ADV_CONTENTS" name="MEM_ADV_CONTENTS"><c:out value="${row.MEM_ADV_CONTENTS }" /></textarea>
	                </div>
	            </li>
	            <li class="answer">
	                <div class="tit">
	                ...
	                <div class="field">
	                    <p>
	                        <input type="radio" name="MEM_ADV_MAIL_YN" id="MEM_ADV_MAIL_YN1" value="Y" <ui:select v="${row.MEM_ADV_MAIL_YN}" t="Y" g="checked"/> class="radio">
	                        <label for="MEM_ADV_MAIL_YN1">이메일</label>
	                    </p>
	                    <p>
	                        <input type="radio" name="MEM_ADV_MAIL_YN" id="MEM_ADV_MAIL_YN2" value="T" <ui:select v="${row.MEM_ADV_MAIL_YN}" t="T" g="checked"/> class="radio">
	                        <label for="MEM_ADV_MAIL_YN2">전화상담</label>
	                    </p>
	                    <p>
	                        <input type="radio" name="MEM_ADV_MAIL_YN" id="MEM_ADV_MAIL_YN3" value="N" <ui:select v="${row.MEM_ADV_MAIL_YN}" t="N" g="checked"/> class="radio">
	        ...
	        <div class="section-button"><!-- section-button -->
	            <a href="javascript:;" id="goRegist" class="button warning"><span>수정</span></a>
...
$(function(){
    ...
    {
		var oldcode = "<c:out value="${row.MEM_ADV_QST_TYPE}" />";
    	var selected = "";
		$.ajax({
            type	: "POST",
            ...
            success	: function(data)
            {
                ...
                {  
                	selected = "";
                	if(item.CMN_COM_IDX == oldcode){
                		selected = "selected=true";
                	}
                	$("#MEM_ADV_QST_TYPE").append("<option value='"+item.CMN_COM_IDX+"' "+selected+">"+item.CMN_COM_NM+"</option>").change();
    ...
    $('#MEM_ADV_QST_TYPE_UP').trigger('click');
});
//]]>
</script>
</body>

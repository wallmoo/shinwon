		...
		<div class="container"><!-- container -->
			<div class="wrap"><!-- warp -->
				...
				<div class="tab-b item-3"><!-- tab-b -->
				    <ul class="tab">
				        <li><a href="<c:out value="${mobileDomain }"/>/mobile/brand/brandAboutMountia.do"><span>ABOUT<br />MOUNTIA</span></a></li>
				        <li class="active"><a href="javascript:;"><span>HISTORY</span></a></li>
				        <li><a href="<c:out value="${mobileDomain }"/>/mobile/brand/brandPressCenterList.do"><span>PRESS CENTER </span></a></li>
				    </ul>
				</div><!-- // tab-b -->

				<div class="gap"><!-- gap -->
					${historyMountiaMap.CON_MST_MOBILE_PROMOTION }
				</div><!-- // gap -->

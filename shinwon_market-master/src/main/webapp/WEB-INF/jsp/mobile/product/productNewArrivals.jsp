  			...
  			<div id="contents"><!-- contents -->
                ...
                <div class="container"><!-- container -->
                    <div class="wrap"><!-- wrap -->
                        ...
                        <div id="listNewArrivals" class="wrap-product image"><!-- wrap-product -->
...
$(function(){
	...
	goPage = function (cPage) 
	{
	    ...
	    $frm.attr({"action":"<c:out value="${mobileDomain}"/>/mobile/product/productNewArrivals.do", "target":"_self", "method":"get"}).submit();
	};

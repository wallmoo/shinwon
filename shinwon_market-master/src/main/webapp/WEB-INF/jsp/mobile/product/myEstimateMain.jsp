...
<section id="wrap">
	...
	<article id="container" class="container" data-role="content">
        ...
        <div class="estimate-guide accordion" data-role="collapsible-set"><!-- estimate-guide -->
            <div class="section" data-role="collapsible" data-collapsed="true">
                ...
                <div class="toggle-box">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">STEP01<br />상품 선택</th>
                            <td>
                                키핑 상품, 베스트 상품, 나만의 상품, 카테고리 검색  등의 다양한 방법으로 원하는 상품을 찾아보세요.
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">STEP02<br />상품 담기</th>
                            <td>
                                찾으신 상품을 견적서에 담아주세요.
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th scope="row">STEP04<br />견적 신청하기</th>
                            <td>
                                선택하신 상품과 가격, 희망금액을 확인하신 후에 &lsquo;견적요청&rsquo;을 선택해 주세요.
                            </td>
                        </tr>
                    </tbody>
                    </table><!-- // table-b -->
                        ...
                        <dl class="ui-content">
                            ...
                            <dd class="tx_msg">
                                <ul class="list list-a">
                                    <li>고객님이 구매 원하는 상품을 모아서 원하는 희망금액으로 견적을 신청하시면 희망금액을 검토하여 상품 구매를 도와드리는 서비스입니다.</li>
                                    <li>견적 신청 결과는 <a href="javascript:;" class="primary">마이페이지&gt;쇼핑활동&gt;MY견적</a>에서 확인 가능합니다.</li>
                                    <li>맞춤견적을 통해 할인된 금액으로 구매 시 쿠폰할인은 적용되지 않습니다.</li>
                                </ul>
                            </dd>
                        </dl>
        ...
        <div class="estimate-item accordion" data-role="collapsible-set"><!-- estimate-guide -->
            <div class="section" data-role="collapsible" >
                <h4 class="h3">
                    <strong>키핑 상품 담기</strong>
                    <i><!-- icon --></i>
                </h4>
                ...
                <div class="padder toggle-box">
                    ...
                    <c:choose>
                    	...
                    	<p class="no-more">등록된 상품이 없습니다.</p>
                    	</c:when>
                    	<c:otherwise>
                    	<ul class="product-list _scroll_list_ck">
                    	<c:forEach var="row" items="${keepList }" varStatus="sta">
                            <li>
                                <div class="module">
                                	<c:if test="${row.ESM_CRT_CNT eq 0 and row.PRD_MST_OPT_EST_CNT > 0 }">
                                	<span class="tx_opt">
										<i class="ico_pot_tx">옵션필수선택상품</i>
									</span>
									</c:if>
                                    <a href="javascript:;">
                                        <span class="thumb"><img data-original="<c:out value="${cdnDomain}${row.IMG_THUMBNAIL}" />" src="<c:out value="${cdnDomain}"/>/mobile/img/lay/grey.gif" alt="" /></span>
                                ...
                                <div class="action">
                                    <a href="javascript:void(0)" data-prd_mst_cd="<c:out value="${row.PRD_MST_CD }" />" data-prd_mst_opt_est_cnt="<c:out value="${row.PRD_MST_OPT_EST_CNT }" />" data-prd_mst_price="<c:out value="${row.PRD_MST_DSP_PRC }"/>" class="button primary" id="putBtn"><span>담기</span></a>
                                </div>
                            </li>
						</c:forEach>                            
                        </ul>
            ...
            <div class="section" data-role="collapsible" >
                ...
                <div class="padder toggle-box">
                    ...
                    <c:choose>
                    	...
                    	<c:otherwise>
                    	<ul class="product-list _scroll_list_ck">
                    	<c:forEach var="row" items="${cartList }" varStatus="sta">
                            <li>
                                <div class="module">
                                    <a href="javascript:;">
                                        <span class="thumb"><img data-original="<c:out value="${cdnDomain}${row.IMG_THUMBNAIL}" />" src="<c:out value="${cdnDomain}"/>/mobile/img/lay/grey.gif" alt="" /></span>
        ...
        <div class="estimate-item accordion" data-role="collapsible-set"><!-- estimate-guide -->
            <div class="section" data-role="collapsible" >
                <h4 class="h3">
                    <strong>개인 맞춤형 추천</strong>
                    <i><!-- icon --></i>
                </h4>

                <div class="padder toggle-box">
                    <div class="product-list-wrap"><!-- product-list-wrap -->
                        <ul class="product-list _scroll_list_ck" id="recommendItems">
                            <li>
                                <div class="module">
                                    <a href="javascript:;">
                                        <span class="thumb"><img data-original="http://www.etland.co.kr/etlandbo/product/images/1092975_M1.jpg" src="../nas/cdn/mobile/img/lay/grey.gif" alt="" /></span>
                                        <span class="subject">[캐리어/CSR-A063WE] 벽걸이...</span>
                                    </a>
                                    <p class="price-after">
                                        <span class="blind">판매가</span><strong class="large">1,100,000</strong>원
                                        <em class="discount">
                                            <span class="blind">할인률</span>
                                ...
                                <div class="action">
                                    <a href="javascript:;" class="button primary"><span>담기</span></a>
                                </div>
                            </li>
                            <li>
                                <div class="module">
        ...
        <div class="estimate-item accordion pr_info_d" data-role="collapsible-set"><!-- estimate-guide -->
            <div class="section" data-role="collapsible" >
                <h4 class="h3">
                    <strong>카테고리 검색</strong>
                    <i><!-- icon --></i>
                </h4>

                <div class="padder toggle-box">
                    <div class="search-form mt10"><!-- search-form -->
                        <h5>카테고리 선택</h5>
                        <p>
		...
		<div class="fixed_btnBox_b" style="display:none;"><!-- fixed_btnBox_b-->
            <a href="javascript:goEstimate();" class="button warning full"><span>맞춤견적서 가기 (총 <c:out value="${totalCount }" />개 )</span></a>
        </div><!-- // fixed_btnBox_b-->
	</article>
	<!--// #container E -->
...
function _return_scrollList(_idx, _reNum){
    ...
    */
    ...
    if(_parent_idx != 0){
    	...
    	if(_parent_idx == 1){
    		url		= "<c:out value="${mobileDomain}" />/mobile/product/myEstimateKeepingAjax.do";	
    		total	= "<c:out value="${keepPaging.totalPageCount}"/>";
    	}else if (_parent_idx == 2){
    		url		= "<c:out value="${mobileDomain}" />/mobile/product/myEstimateCartAjax.do";
    		total	= "<c:out value="${cartPaging.totalPageCount}"/>";
    	}else if (_parent_idx == 3){
    		url		= "";
    	}else if (_parent_idx == 4){
...
$(document).ready(function(){
	...
	goEstimate			= function(){
		location.href = "<c:out value="${serverDoamin}" />/mobile/product/myEstimateList.do";
	};
});

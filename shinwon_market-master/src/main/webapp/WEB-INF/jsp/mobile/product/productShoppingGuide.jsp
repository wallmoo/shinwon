		...
		<div class="container"><!-- container -->
			<div class="wrap gutter">
				...
				<div class="wyzwyg"><!-- wyzwyg -->
					<c:choose>
						<c:when test="${not empty productShoppingGuide}" >
                        	<div class="module">
                        		${productShoppingGuide.BRD_GDS_CONTENTS}
                         	</div>
                        </c:when>
                    </c:choose>
                    <c:choose>
						<c:when test="${not empty productAsGuide}" >
                        	<div class="module">
                            	${productAsGuide.BRD_GDS_CONTENTS}
                            </div>
                        </c:when>
                    </c:choose>
				</div><!-- // wyzwyg -->

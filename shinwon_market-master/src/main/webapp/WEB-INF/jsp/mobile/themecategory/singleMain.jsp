...
<section id="wrap">
	...
	<article id="container" class="container" data-role="content">
		...
		<section class="single_main">
			<h2><img src="<c:out value="${cdnDomain}" />/mobile/img/thema/img_sing_title.jpg" alt="당신의 화려하고 당당한 싱글라이프!" /></h2>

			<nav class="ui-grid-a thema_nav _hd_fix">
				<a href="#guide_d" class="ui-block-a on"><strong>싱글독립 가이드북</strong></a>
				<a href="#package_d" class="ui-block-b"><strong>싱글 독립 패키지</strong></a>
			</nav>
			...
			<dl id="package_d" class="package_d">
				<dt>
					<h3>
						...
						<strong>싱글독립 패키지</strong>
					</h3>
					<div class="mn">
						<a href="javascript:void(0)" class="on single" ><strong class="bg_package_thum01">알뜰형</strong></a>
						<a href="javascript:void(0)" calss="single" ><strong class="bg_package_thum02">실속형</strong></a>
						<a href="javascript:void(0)" class="single" ><strong class="bg_package_thum03">트랜드슈머</strong></a>
					</div>
				</dt>
				<form method="post" name="frm" id="frm">
				<input type="hidden" name="tabIdx" id="tabIdx" value="product1" />
				<input type="hidden" name="PRD_MST_CDs" id="PRD_MST_CDs" value="" />
				<input type="hidden" name="ESM_MST_TYPE" id="ESM_MST_TYPE" value="1817" />
				<dd class="pr_list" id="product1">
					<strong>알뜰형 SHOW ROOM</strong>
					<hr class="hr_3px_st2" />
				...
				<dd class="pr_list" id="product2" style="display:none;">
					<strong>실속형 SHOW ROOM</strong>
					<hr class="hr_3px_st2" />
				...
				<dd class="pr_list" id="product3" style="display:none;">
					<strong>트랜트형 SHOW ROOM</strong>
					<hr class="hr_3px_st2" />
					<ul class="ui-grid-a">
				...
				<dd class="pr_gift" id="Banner1">
					...
					<p>
						<i></i>
						<span class="tx_ti">패키지 구매 시 추가 마일리지 적립v</span>
				...
				<dd class="pr_gift" id="Banner2" style="display:none;">
				...
				<dd class="pr_gift" id="Banner3" style="display:none;">
				...
				<dd class="total_prc">
					<dl>
						...
						<dd class="pkg_prc">
							<strong class="ti">싱글 패키지금액</strong>
				...
				<dd class="tx_guide">
					<strong>
						싱글킹은 고객님의 행복한 독립준비를 함께 하기 위하여<br> 
...
$(document).ready(function(){
	...
	goDetail		= function(a,b,c){
		location.href = "<c:out value="${mobileDomain}" />/mobile/themecategory/singleConList.do?MGZ_MST_THM_CTG1=" + a + "&MGZ_MST_THM_CTG2=" + b + "&MGZ_MST_THM_CTG3="+ c; 
	};

...
<script type="text/javascript" src="/nas/cdn/pc/mobile/naveridlogin_js_sdk_2.0.0.js" charset="utf-8"></script>   <!-- naver 자바스크립트 SDK -->
<script type="text/javascript">

	var siteDomain = "<c:out value="${mobileDomain}" />";
	var naverCallbackUrl = siteDomain+"/mobile/manager/naverCallbackUrl.do";

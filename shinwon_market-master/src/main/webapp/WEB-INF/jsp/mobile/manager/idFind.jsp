        ...
        <div id="container">
            ...
            <div id="content_area">
                ...
                <div class="tab_wrap pd_reset">
                    <ul class="tab st3 n2">
                        <li class="on"><a href="#tab1">아이디 찾기</a></li>
                        <li><a href="<c:out value="${mobileDomain }"/>/mobile/manager/pwFind.do?gubun=PW">비밀번호 찾기</a></li>
                    </ul>
...
<script>
	$(function(){
		...
		*/
	    ...
	    {
	    	$basicForm.attr({"action":"<c:out value="${serverSslDomain}" />/mobile/manager/idFindResult.do", "target":"_self", "method":"post"}).submit();
	    };
	    ...
	    goIdFind = function()
	    {
	    	...
	    	if(searchType == "memberSimple"){
	    		...
	    		if($simpleForm.valid()){
	    			$simpleForm.attr({"action":"<c:out value="${serverSslDomain}" />/mobile/manager/idFindResult.do", "target":"_self", "method":"post"}).submit();	    			
	    		}	    			
			}
	    	// 기업회원의 경우
	    	if(searchType == "memberBusiness"){
	    		...
	    		if($businessForm.valid()){
	    			$("#businessForm").attr({"action":"<c:out value="${serverSslDomain}" />/mobile/manager/idFindResult.do", "target":"_self", "method":"post"}).submit();	    			
	    		}
	    	}
	    };

		...
		*/
		...
		public String getPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
			...
			if(wnanchor.getFirstPage() != -1) {
				sbRet.append("<a class=\"ico_ar_l\" href=\"#none\" onClick=\"javascript:doPaging('"+wnanchor.getBundleBefore()+"');\" title=\"이전페이지\"><span class=\"blind\">이전페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_l\" href=\"#none\" title=\"이전페이지\"><span class=\"blind\">이전페이지</span></a>");
			} 
			...
			for(int i=0; i<pageCount && i < pages.length; i++) {
				if(pages[i][1].equals("-1")) {
					sbRet.append("<a href=\"#none\" class=\"on\">" +"<span>"+ pages[i][0] + "</span>");
				} else {
			...
			if(wnanchor.getBundleNext() != -1) {
    			sbRet.append("<a class=\"ico_ar_r\" href=\"#none\" onClick=\"javascript:doPaging('"+wnanchor.getBundleNext()+"')\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
			} else {
				sbRet.append("<a class=\"ico_ar_r\" href=\"#none\" title=\"다음페이지\"><span class=\"blind\">다음페이지</span></a>");
			}

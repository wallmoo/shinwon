<%@ page pageEncoding = "UTF-8" %><%!
	...
	*/
	...
	public String[] COLLECTIONS = new String[]{"mobile_postnm"};
	public String[] COLLECTIONS_NAME = new String[]{"mobile_postnm"};
	public class WNCollection{
	public String[][] MERGE_COLLECTION_INFO = null;
	public String[][] COLLECTION_INFO = null;
		WNCollection(){
			...
			{
					{
						"mobile_postnm", // set index name
						"mobile_postnm", // set collection name
						...
						"DOCID,BASE_ZONE,SIDO,SIGUNGU,BUBJUNG_DONG,DORO,BUILDING1,BUILDING2,JIBUN1,JIBUN2,MOUNT_YN,SIGUNGU_BUILDING,DORO_ADDR,JIBUN_ADDR,ALIAS",// set document field
						"", // set date range
						"", // set rank range
						...
						"mobile_postnm" // collection display name
						}
			};
		}
	}

	...
	<section id="wrap">
		...
		<section class="combineMem">
			<form id="dataForm" name="dataForm" method="post">
				...
				<input type="hidden" name="SMS_YN" id="SMS_YN" value="<c:out value="${commandMap.SMS_YN }"/>"/>
				<input type="hidden" name="TM_YN" id="TM_YN" value="<c:out value="${commandMap.TM_YN }"/>"/>
				<input type="hidden" name="DM_YN" id="DM_YN" value="<c:out value="${commandMap.DM_YN }"/>"/>
				<input type="hidden" name="EMAIL_YN" id="EMAIL_YN" value="<c:out value="${commandMap.EMAIL_YN }"/>"/>
			...
			<dl>
				<dt>
					<h3>마켓플랜트 회원가입</h3>
					<p class="sub_tx">
						<span>마켓플랜트 통합회원으로 가입하시면 마켓플랜트와 전국 매장에서 마일리지 적립 및 다양한 혜택을 받으실 수 있으며 프로모션과 이벤트 참여가 가능합니다.</span>
				...
				<dd class="dd_clause">
					<div class="tx_chk">
						<p>
							<span>통합 회원 전환을 위해서 <br/>아래  회원약관, 개인정보취급방침, 개인정보 선택 제공에 대한 안내를 읽고 동의해주세요. </span>
						</p>
 ...
 회사는 회원이 회사의 개인정보 보호정책 또는 이용약관의 내용에 대하여 동의 또는 동의안함을 선택할 수 있는 절차를 마련하여, 동의를 선택하면 수집에 동의한 것으로 봅니다. 
						...
						<li>
							...
							<div data-role="collapsible">
								...
								<div class="acc_con">
									<pre>
<strong>OK캐쉬백 카드서비스 이용약관</strong> 
...
본 약관은 SK플래닛(주) (이하 "SK플래닛")이 제공하는 OK캐쉬백 카드서비스를 이용함에 있어 이용자 및 SK플래닛의 제반 권리/의무와 관련 절차 등을 규정하는데 그 목적이 있습니다.   
						...
						<li class="ti_chk">
							...
							<fieldset data-role="controlgroup" class="chk_st0">
								...
								<label for="chk_clause_6" class="co_red">(선택)</label>
							</fieldset>	
							<fieldset data-role="controlgroup" class="chk_st1">
								<input type="checkbox" name="TRM_YN0005" id="TRM_YN0005" value="Y">
								<label for="TRM_YN0005">aaaa(주)</label>
								<input type="checkbox" name="TRM_YN0006" id="TRM_YN0006" value="Y">
								<label for="TRM_YN0006">bbbb(주)</label>
								<input type="checkbox" name="TRM_YN0007" id="TRM_YN0007" value="Y">
								<label for="TRM_YN0007">cccc(주)</label>
								<input type="checkbox" name="TRM_YN0008" id="TRM_YN0008" value="Y">
								<label for="TRM_YN0008">dddd(주)</label>
							</fieldset>
							<div data-role="collapsible">
								<h4>

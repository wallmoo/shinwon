		...
		<section class="combineMem">
			...
			<dl>
				...
				<dd class="dd_clause">
					<div class="tx_chk">
						<p>
							<span>회원가입을 위하여 아래 회원약관, 개인정보취급방침, 멤버십 서비스 약관, OK캐쉬백 서비스 이용약관, 개인정보 선택 제공에 대한 안내를 읽고 동의해주세요. </span>
						</p>
...
※ PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질을 반하지 않는 한 이 약관을 준용합니다.
						...
						<li>
							...
							<div data-role="collapsible">
								<h4>
									<strong>쇼핑몰 개인정보 취급방침 동의</strong>
									<i></i>
								</h4>
								<div class="acc_con">
									<pre>
...
본 약관은 마켓플랜트 멤버십카드 회원이 당사가 제공하는 마켓플랜트 멤버십 카드 서비스를 이용함에 있어 마켓플랜트 멤버십카드 회원과 당사의 제반 권리, 의무 및 관련절차 등을 규정하는데 그 목적이 있습니다.  
						...
						<li>
							...
							<div data-role="collapsible">
								...
								<div class="acc_con">
									<pre><strong>OK캐쉬백 카드서비스 이용약관</strong>
</pre>
								</div>
							</div>

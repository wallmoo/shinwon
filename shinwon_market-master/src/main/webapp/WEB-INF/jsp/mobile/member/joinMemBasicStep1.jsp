...
$(function(){
    ...
    goDataForm = function()
    {
    	$("#dataForm").attr({"action":"<c:out value="${mobileSslDomain}" />/mobile/member/joinMemBasicStep2.do", "target":"_self", "method":"post"}).submit();
    };
    ...
    {
    	$("#offlineForm").attr({"action":"<c:out value="${mobileSslDomain}" />/mobile/member/offlineMemStep1.do", "target":"_self", "method":"post"}).submit();
    };
});
//]]>
</script>

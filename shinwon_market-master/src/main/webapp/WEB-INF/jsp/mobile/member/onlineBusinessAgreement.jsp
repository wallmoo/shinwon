		...
		<article id="container" class="container" data-role="content">
	        ...
	        <div class="tab-a mt20" data-role="navbar"><!-- tab-a -->
	            <ul>
	                ...
	                <li class="active"><a href="javascript:;">기업회원</a><span class="blind">현재위치</span></li>
	        ...
	        <div class="padder access-terms"><!-- access-terms -->
	            ...
	            <div class="links"><!-- links -->
	                <div class="holder">
	                    <ol class="ct list">
	                        ...
	                        <li><a href="#accessZ" target="_self">제 26조 부칙 제 1조 (약관의 효력)</a></li>
	                    </ol>
	                </div>
	            </div><!-- //links -->
	            ...
	            <ul class="list list-ol-b">
	                <li><span>①</span> 이용자는 &ldquo;몰&rdquo;이 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다. 회원의 특성에 따라 아이핀/휴대폰 인증, 이메일인증, 사업자 인증 등의 방법으로 인증 절차를 반드시 거쳐야 합니다.</li>
	                <li><span>②</span> &ldquo;몰&rdquo;은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각호에 해당하지 않는 한 회원으로 등록합니다.
	                    <ol class="list list-ol">
	                        <li>등록 내용에 허위, 기재누락, 오기가 있는 경우</li>
	                        <li>회원 가입일 현재 만 20세 미만인 경우</li>
	                ...
	                <li><span>⑤</span> &ldquo;몰&rdquo;에서 사업자인증 확인 후 &ldquo;마켓플랜트 온라인몰&rdquo; 기업회원으로 가입할 수 있습니다.</li>
	            ...
	            <ul class="list list-ol-b">
	                <li><span>①</span> 제 17조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게 있습니다.</li>
	            ...
	            <h4 id="accessZ">제 26조  부칙 제 1조 (약관의 효력)</h4>

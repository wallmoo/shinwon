				...
				<script type="text/javascript">
				    $(function () {
				    	...
				    	if("${commandMap.gubun}" == "JOIN")
				    	{
					    	...
					    	$("#MEM_IPN_HP_CRP",$opener).val("${commandMap.MEM_IPN_HP_CRP}");
					    	$("#MEM_IPN_CRT_DT",$opener).val("${commandMap.MEM_IPN_CRT_DT}");	
				    	...
				    	if("${commandMap.returnVal}" == -3 || "${commandMap.returnVal}" == -4){
					    	...
					    	if(navigator.userAgent.indexOf("MobileApp") > -1 ){
				    			parent.goChangeOfflineDataForm();
				    		}else{
				    	...
				    	if("${commandMap.changeSimpleMem}" == "Y")
				    	{
				    		...
				    		if(navigator.userAgent.indexOf("MobileApp") > -1 ){
				    			parent.goChangeSimpleMemDataForm();
				    		}else{

...
public class DoubleSubmitTag extends TagSupport {
	...
	public int doStartTag()	throws JspException {
		...
		if(!tokenKey.equals(EgovDoubleSubmitHelper.DEFAULT_TOKEN_KEY))
		{
		    buffer.append("<input type='hidden' name='").append("tokenKey").append("' value='").append(tokenKey).append("'/>");    
		}

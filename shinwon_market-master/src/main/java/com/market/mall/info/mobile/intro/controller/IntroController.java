package com.market.mall.info.mobile.intro.controller;
...
@Controller("mobileIntroController")
public class IntroController {

	 @Resource(name="mobileIntroService")
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/intro/introCompany")
	 public ModelAndView introComp(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
		 ...
		 mv.setViewName("/info/mobile/intro/introCompany");
		 return mv;
	 }
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/intro/introPhilosophy")
	 public ModelAndView introPhilosophy(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
		 ...
		 mv.setViewName("/info/mobile/intro/introPhilosophy");
		 return mv;
	 }
	 /**
	  * 
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/intro/introPressView")
	 public ModelAndView introPressView(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
	     ...
	     mv.setViewName("/info/mobile/intro/introPressView");
	     return mv;
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/intro/introPressListAjax")
...
//		 System.out.println("json start::::::>" + json);
	 ...
	 /**
	    ...
	    * @throws Exception
	    */
	    @RequestMapping("/info/mobile/intro/introFileDownload")

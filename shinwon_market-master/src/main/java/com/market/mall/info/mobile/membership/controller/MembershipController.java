package com.market.mall.info.mobile.membership.controller;
...
@Controller("mobileMembershipController")
...
//	 
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/membership/membershipGuide")
	 public ModelAndView membershipGuide(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
		 ...
		 mv.setViewName("/info/mobile/membership/membershipGuide");
		 return mv;
	 }
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/membership/membershipGrade")
	 public ModelAndView membershipGrade(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
		 ...
		 mv.setViewName("/info/mobile/membership/membershipGrade");
		 return mv;
	 }

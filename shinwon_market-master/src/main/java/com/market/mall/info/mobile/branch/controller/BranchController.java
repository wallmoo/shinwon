package com.market.mall.info.mobile.branch.controller;
...
public class BranchController {
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/branch/branchList")
	 public ModelAndView branchPress(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
		 ...
		 mv.setViewName("/info/mobile/branch/branchList");
		 return mv;
	 }
	 /**
	  * 
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/branch/branchView")
	 public ModelAndView branchView(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
	     ...
	     mv.addObject("commandMap", commandMap);
	     mv.setViewName("/info/mobile/branch/branchView");
	     return mv;
	  ...
	  * @throws Exception
	  */
	 @RequestMapping("/info/mobile/branch/branchListAjax")
...
//		 System.out.println("json start::::::>" + json);
	 ...
	 /**
	    ...
	    * @throws Exception
	    */
	    @RequestMapping("/info/mobile/branch/branchFileDownload")
	     ...
	     * @throws Exception
	     */
	     @RequestMapping("/info/mobile/branch/getSubCodeAjax")

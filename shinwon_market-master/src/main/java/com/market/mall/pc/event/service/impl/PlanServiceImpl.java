...
public class PlanServiceImpl implements PlanService {
	...
	*/
	...
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> selectPlanCategoryList(Map<String, Object> commandMap) throws Exception {
		return defaultDAO.selectList("PcPlan.selectPlanCategoryList", commandMap);
	}
	...
	*/
	...
	public Map<String, Object> selectPlanInfo (Map<String, Object> commandMap) throws Exception{
    	...
    	//상품 옵션 공통 코드 리스트
    	List<Map<String,Object>> prdColorList = defaultDAO.selectList("PcPlan.selectPlanCommonOption", commandMap);
    	
        // 상품구성 그룹의 상품 목록
    	List<Map<String, Object>> detailList = defaultDAO.selectList("PcPlan.selectPlanDetailList", commandMap);
        
    	for(int index=0; index < detailList.size(); index++){
    	    List<Map<String,Object>> tmpColorList = new ArrayList<Map<String, Object>>();
    	    String prdCode = StringUtil.getString(detailList.get(index).get("PLN_PRD_MST_CD"));

    	    for(int j=0; j<prdColorList.size(); j++){
    	        if(prdCode.equals(prdColorList.get(j).get("PLN_PRD_MST_CD"))){
    	            tmpColorList.add(prdColorList.get(j));
    	        }
    	    }
    	    detailList.get(index).put("PRD_CMM_OPT",tmpColorList);
    	}
	...
	*/
	...
	public int planSecretSaleCheck(Map<String, Object> commandMap) throws Exception {
		// TODO Auto-generated method stub
		int result		= defaultDAO.selectCount("PcPlan.planSecretSaleCheck", commandMap);

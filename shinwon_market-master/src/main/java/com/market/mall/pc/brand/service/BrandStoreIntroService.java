 ...
 * @FileName : BrandStoreIntroService.java
 * @Date : 2015. 6. 12.
 * @프로그램 설명 : 사용자 > 브랜드사이트 > 매장안내 관련하여 처리하는 Service Interface
 * @author DEV_KIMSOYOUNG
 */
public interface BrandStoreIntroService 
{
	
	/**
	* <pre>
	* 1. MethodName : selectStoreAreaList
	* 2. ClassName : BrandStoreIntroService.java

...
public class BrandController {
	...
	@RequestMapping("/pc/brand/brand.do")
    public ModelAndView brand(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception
    {
    	...
    	MmMap.put("BANNER_LEFT", 1313);
    	MmMap.put("BANNER_RIGHT", 1314);
    	
    	// -- 전시영역 index map
	
        // banner list
        List<Map<String, Object>> listLeftBanner = new ArrayList<Map<String,Object>>();
        List<Map<String, Object>> listRightBanner = new ArrayList<Map<String,Object>>();
        
        //select banner list
        commandMap.put("BANNER_IDX", MmMap.get("BANNER_LEFT"));
        listLeftBanner = this.productListService.selectBannerDisplayList(commandMap);
        commandMap.put("BANNER_IDX", MmMap.get("BANNER_RIGHT"));
        listRightBanner = this.productListService.selectBannerDisplayList(commandMap);
        
        // mv setting 
        mv.addObject("listLeftBanner", listLeftBanner);
        mv.addObject("listRightBanner", listRightBanner);
        mv.setViewName("pc/brand/brand"); 
        mv.addObject("commandMap", commandMap);

        return mv;
    }
	/**
     * @api {GET} /pc/brand/brandMain.do
     * @apiName 브랜드 메인화면
     * @apiGroup 브랜드
     * 
     ...
     */
    @RequestMapping("/pc/brand/brandMain")
    ...
    /**
     * @api {POST} /pc/brand/brandView.do
     * @apiName 브랜드 상세화면
     * @apiGroup 브랜드
     * 
     ...
     */
    @RequestMapping("/pc/brand/brandView")
    ...
    /**
     * @api {POST} /pc/brand/searchBrandProductAjax.do
     ...
     */
    @RequestMapping("/pc/brand/searchBrandProductAjax")
    public ModelAndView searchBrandProductAjax(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception
    {
        ...
        // 페이지 당 기본 출력 갯수
        int curSize = Integer.parseInt(StringUtil.getString(commandMap.get("pageSize"), "30"));
        ...
        int totalCount  = this.brandService.selectBrandProductCount(commandMap);
    ...
    /**
     * @api {POST} /pc/brand/searchBrandListAjax.do
     ...
     * @apiSuccess {Integer} totalCount 브랜드 검색 결과 총 갯수
     */
    @RequestMapping("/pc/brand/searchBrandListAjax")
    public ModelAndView searchBrandListAjax(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception
    {
        ...
        if((arrSEARCH_KOR != null && arrSEARCH_KOR.size() > 0) || (arrSEARCH_ENG != null && arrSEARCH_ENG.size() > 0)) {
        	commandMap.put("arrSearchYN", "Y");
        }

...
public interface EstimateManagementService {
	 ...
	 * 
	 * <pre>
	 * 1. MethodName : myEstimateKeepingListCount
	 * 2. ClassName : EstimateManagementService.java
	 * 3. Comment : 나만의 견적 > 키핑 수 
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 1. 28.
	 * </pre>
	 *
	 ...
	 * 
	 * <pre>
	 * 1. MethodName : selectMyEstimateCareListCount
	 * 2. ClassName : EstimateManagementService.java
	 * 3. Comment : 나만의 견적 > 카테고리 리스트 수 
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 1. 28.
	 * </pre>
	 *
	 ...
	 * 
	 * <pre>
	 * 1. MethodName : selectMyEstimateCareList
	 * 2. ClassName : EstimateManagementService.java
	 * 3. Comment : 나만의 견적 > 카테고리 리스트  
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 1. 28.
	 * </pre>
	 *

...
@Controller("pcVendorSellerPickController")
public class VendorSellerPickController {
    ...
    private CommonService pcCommonService;
	 ...
	 /**
     * @api {POST} /pc/sellerpick/sellerPickList.do
     * @apiName 셀러픽 메인화면
     * @apiGroup 셀러픽
     *
     ...
     */
    @RequestMapping("/pc/sellerpick/sellerPickList")
    ...
    /**
     * @api {POST} /pc/sellerpick/sellerpickView.do
     * @apiName 셀러픽 상세화면
     * @apiGroup 셀러픽
     *
     ...
     */
    @RequestMapping("/pc/sellerpick/sellerpickView")
    public ModelAndView sellerpickView (HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception{
        ...
        sellerpickInfo.put("CNT_MST_PC_BANNER" , StringUtil.getHtmlStrCnvr( StringUtil.getString( sellerpickInfo.get("CNT_MST_PC_BANNER") ,"")  ) );
        sellerpickInfo.put("CNT_MST_MOBILE_BANNER" , StringUtil.getHtmlStrCnvr( StringUtil.getString( sellerpickInfo.get("CNT_MST_MOBILE_BANNER") ,"")  ) );        
        
        sellerpickInfo.put("CNT_MST_PC_SCRIPT" , StringUtil.getHtmlStrCnvr( StringUtil.getString( sellerpickInfo.get("CNT_MST_PC_SCRIPT") ,"")).replaceAll( "x-", "") );
        sellerpickInfo.put("CNT_MST_MOBILE_SCRIPT" , StringUtil.getHtmlStrCnvr( StringUtil.getString( sellerpickInfo.get("CNT_MST_MOBILE_SCRIPT") ,"")  ) );         
    ...
    /**
     * @api {POST} /pc/sellerpick/sellerpickProductAjax.do
    ...
    public JSON sellerpickProductAjax (HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception{
        ...
        String sJsonArrSearchSize =  StringUtil.getString(commandMap.get("searchSize"),"");
        String sJsonArrSearchColor =  StringUtil.getString(commandMap.get("searchColor"),"");
        String sJsonArrSearchPrice =  StringUtil.getString(commandMap.get("searchPrice"),"");
        ...
        List<Map<String, Object>> sellerpickProductList = this.pcVendorSellerPickService.selectSellerPickProductList(commandMap);
    ...
    /**
     * @api {POST} /pc/sellerpick/sellerPickListAjax.do
     * @apiName 셀러픽 목록  ajax
     * @apiGroup 셀러픽
     *
     * @apiParam {Integer} cPage 현재 페이지  
     ...
     */
    @FrontBannerSkip()
    @RequestMapping("/pc/sellerpick/sellerPickListAjax")
    public JSON sellerPickListAjax (HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception{
        ...
        List<Map<String, Object>> list = this.pcVendorSellerPickService.selectSellerPickList(commandMap);

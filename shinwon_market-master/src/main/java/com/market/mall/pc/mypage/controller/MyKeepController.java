 ...
 * @Date : 2016. 1. 28.
 * @프로그램 설명 : 사용자 > MYPAGE > 쇼핑컨텐츠 > 키핑백을 처리하는 Controller Class
 * @author DEV_KIMSOYOUNG
 */
@Controller("pcMyKeepController")
public class MyKeepController {
	...
	*/
    ...
    @RequestMapping("/pc/mypage/myKeepProductList")
    public ModelAndView myKeepProductList (HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception
    {
        ...
        else
        {
        	...
        	commandMap.put("url", request.getAttribute("frontDomain") + "/pc/mypage/myKeepProductList.do");
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping(value = "/pc/mypage/deleteKeepProductAjax.do", method = RequestMethod.POST)
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/deleteSoldOutKeepProductAjax")
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myKeepContentsList")
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping(value = "/pc/mypage/deleteKeepContentsAjax.do", method = RequestMethod.POST)
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myKeepPlanList")
	public ModelAndView myKeepPlanList (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
		if(SessionsUser.isLogin(request))
        {
            ...
            //키핑 기획전 PC 목록 이미지 구분 값
            commandMap.put("CHN_GBN",Code.USER_ENV_TYPE_PC);
            commandMap.put("PLN_MST_CHANNEL_PC_YN","Y");
	...
	* 2. ClassName  : MyKeepController.java
	* 3. Comment    : 사용자 > MYPAGE > 쇼핑컨텐츠 > 키핑백 > 키핑기획전 > 선택 기획전 삭제
	* 4. 작성자       : DEV_KIMSOYOUNG
	* 5. 작성일       : 2016. 1. 29.
	* </pre>
	*
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping(value = "/pc/mypage/deleteKeepPlanAjax.do", method = RequestMethod.POST)
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping(value = "/pc/mypage/deleteEndKeepPlanAjax.do", method = RequestMethod.POST)
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myKeepEventList")
	public ModelAndView myKeepEventList (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
		if(SessionsUser.isLogin(request))
        {
            ...
            //키핑 이벤트 PC 목록 이미지 구분 값
            commandMap.put("CHN_GBN",Code.USER_ENV_TYPE_PC);  
            commandMap.put("EVT_MST_PC_YN","Y");
	...
	* 2. ClassName  : MyKeepController.java
	* 3. Comment    : 사용자 > MYPAGE > 쇼핑컨텐츠 > 키핑백 > 키핑이벤트 > 선택 이벤트 삭제
	* 4. 작성자       : DEV_KIMSOYOUNG
	* 5. 작성일       : 2016. 1. 29.
	* </pre>
	*
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping(value = "/pc/mypage/deleteKeepEventAjax.do", method = RequestMethod.POST)
	...
	*/
	@FrontBannerSkip()
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping(value = "/pc/mypage/deleteEndKeepEventAjax.do", method = RequestMethod.POST)

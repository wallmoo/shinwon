package com.market.mall.pc.store.controller;
...
public class StoreController {
    ...
    /**
     * @api {GET} /pc/store/storeList.do
     * @apiName STORE 메인화면
     * @apiGroup STORE
     * 
     * @apiSuccess {Integer} totalCount 상품 총 개수
     */
    @RequestMapping("/pc/store/storeList")
    public ModelAndView storeList (HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception {
        ...
        commandMap.put("DSP_MST_ENV", Code.USER_ENV_TYPE_PC);
        //타임특가 팝업 이미지 사이즈
        commandMap.put("POPUP_SIZE", Code.PRODUCT_THUMBNAIL_IMAGE_WIDTH);
        //타임특가 팝업 > 테마전시배너 공통코드

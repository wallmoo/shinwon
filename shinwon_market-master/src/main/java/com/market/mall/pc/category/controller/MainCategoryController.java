package com.market.mall.pc.category.controller;
...
public class MainCategoryController {
    ...
    @RequestMapping("/pc/category/productMain")
    ...
    /**
     * @api {GET} /pc/category/productList.do
     * @apiName 상품전시 중_카테고리
     * @apiGroup 상품전시
     *
     ...
     */
    @RequestMapping("/pc/category/productList")
    ...
    /**
     * @api {POST} /pc/category/productListAjax.do
     ...
     */
    @RequestMapping("/pc/category/productListAjax")
    public ModelAndView productListAjax(HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception
    {
        ...
        int totalCount = this.mainCategoryService.selectProductListCount(commandMap);
        ...
        if(totalCount > 0){
            productList = this.mainCategoryService.selectProductList(commandMap);
        }

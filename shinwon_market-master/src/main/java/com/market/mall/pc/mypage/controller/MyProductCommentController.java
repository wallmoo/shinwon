 ...
 * @Date : 2014. 7. 14.
 * @프로그램 설명 : 프론트 > MY LAND > 쇼핑활동 > 상품후기를 처리하는 Controller Class
 * @author kanghk
 */
@Controller("pcMyProductCommentController")
public class MyProductCommentController {
	...
	private final static int _LIST_THUMBNAIL_SIZE_ = Code.THUMBNAIL_SIZE_PC_PRODUCT_LIST_LARGE;
	
	
	@AccessLevelUser(ROLEUSER.user)
    @RequestMapping("/pc/mypage/myProductReviewList")
    public ModelAndView myProductReviewList (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
    {
	...
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myProductReviewForm")
	public ModelAndView myProductReviewForm (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
	    ModelAndView mv = new ModelAndView();
	...
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myProductReviewEdit")
	public ModelAndView myProductReviewEdit (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
	    ModelAndView mv = new ModelAndView();
	...
	* 3. Comment    : 프론트 > MY LAND > 쇼핑활동 > 상품 후기 > 작성 가능한 상품후기 목록
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myWritableProductCommentList")
	public ModelAndView myWritableProductCommentList (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
		if(SessionsUser.isLogin(request))
        {
            ...
            commandMap.put("pageSize", 12); //페이지당 12개
	...
	* 2. ClassName  : MyProductCommentController.java
	* 3. Comment    : 프론트 > MY LAND > 쇼핑활동 > 상품 후기 > 등록한 상품후기 목록
	* 4. 작성자       : DEV_KIMSOYOUNG
	* 5. 작성일       : 2016. 1. 7.
	* </pre>
	*
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
    @RequestMapping("/pc/mypage/myWrittenProductCommentList")
	...
	/**
	* <pre>
	* 1. MethodName : myProductCommentPopup
	* 2. ClassName  : MyProductCommentController.java
	* 3. Comment    : 프론트 > MY LAND > 쇼핑활동 > 상품후기 > 상품후기 작성 등록/수정 팝업 
	* 4. 작성자       : DEV_KIMSOYOUNG
	* 5. 작성일       : 2016. 1. 6.
	* </pre>
	*
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/myProductCommentPopup")
	public ModelAndView myProductCommentPopup (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
		if(SessionsUser.isLogin(request))
        {
			ModelAndView mv = new ModelAndView();
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/insertMyProductComment")
	...
	*/
	@AccessLevelUser(ROLEUSER.user)
	@RequestMapping("/pc/mypage/updateProductComment")
	...
	* 2. ClassName  : MyProductCommentController.java
	* 3. Comment    : 프론트 > MY LAND > 쇼핑활동 > 상품후기 > 상품후기 내용 금칙어 체크
	* 4. 작성자       : DEV_KIMSOYOUNG
	* 5. 작성일       : 2016. 1. 27.
	* </pre>
	*
	...
	*/
	@FrontBannerSkip()
	@RequestMapping("/pc/mypage/checkBanWordAjax")

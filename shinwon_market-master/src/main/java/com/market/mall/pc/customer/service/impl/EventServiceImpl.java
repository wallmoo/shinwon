 ...
 * @Date : 2014. 7. 28.
 * @프로그램 설명 : 프론트 > 고객센터 > 이벤트공지를 처리하는 Service Implement Class
 * @author kanghk
 */
@Service("pcEventService")
public class EventServiceImpl implements EventService {
	...
	*/
	...
	public int selectEventWinListCount(Map<String, Object> commandMap) throws Exception {
		...
		return defaultDAO.selectCount("PcEvent.selectEventWinListCount", commandMap);
	}
	...
	public List<Map<String, Object>> selectEventWinList(Map<String, Object> commandMap) throws Exception {
		// TODO Auto-generated method stub
		return defaultDAO.selectList("PcEvent.selectEventWinList", commandMap);
	}
...
//	    returnMap.put("fileList", defaultDAO.selectList("PcCommon.selectCommonFileList", commandMap));
	    ...
	    returnMap.put("winList", defaultDAO.selectList("PcEvent.selectEventWinerList", commandMap));
	...
	public List<Map<String, Object>> selectEventWinSearchList(Map<String, Object> commandMap) throws Exception {
		// TODO Auto-generated method stub
		return defaultDAO.selectList("PcEvent.selectEventWinSearchList", commandMap);
	}

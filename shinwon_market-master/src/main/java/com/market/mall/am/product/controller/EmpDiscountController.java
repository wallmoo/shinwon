...
public class EmpDiscountController {
    ...
    /**
     * @api {POST} /am/product/empDiscountList.do
     * @apiName 임직원 할인관리 화면
     * @apiGroup SB상품관리
     *
     ...
     */
    @RequestMapping(value="/am/product/empDiscountList")
    public ModelAndView empDiscountList(HttpServletRequest request, @RequestParams() Map<String, Object> commandMap) throws Exception  
    {
        ModelAndView mv = new ModelAndView();
        
        commandMap.put("searchYear", StringUtil.getString(commandMap.get("searchYear"), "S_ALL"));
        commandMap.put("DSC_MST_TYPE", "E"); //임직원 타입
        //할인 상세 리스트
    ...
    /**
     * @api {POST} /am/product/empDiscountRegist.do
     * @apiName 임직원 할인관리 저장
     * @apiGroup SB상품관리
     * 
     ...
     */
    @RequestMapping(value="/am/product/empDiscountRegist")
    public ModelAndView empDiscountRegist(HttpServletRequest request, @RequestParams() Map<String, Object> commandMap) throws Exception  
    {
        ModelAndView mv = new ModelAndView();

...
//    @Resource(name="daumEPService") private DaumEPService daumEPService;
    ...
    //@Scheduled(cron="0 */1 * * * *")
    //@Scheduled(cron="50 0 * * * *")	//실제 설정
	public void BatchEpDaumAll() throws Exception{
        logger.info("===============================");
		// 서버IP 확인
...
//		}
		...
		commandMap.put("BCH_MST_ID", Code.BATCH_CODE_EP_ALL_DAUM); 	// 배치 아이디 	- "53"
		commandMap.put("BCH_MST_NM", Code.BATCH_NAME_EP_ALL_DAUM); 	// 배치 명 		- [관리] 다음 EP 데이터 전체분 생성
...
//	    		daumEPService.makeDaumAllProductEP();
	    		json.put("resultYn","Y");

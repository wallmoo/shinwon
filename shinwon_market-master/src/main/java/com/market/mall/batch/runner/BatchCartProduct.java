...
import com.market.mall.batch.service.BatchCartProductService;
 ...
 */
@Component
public class BatchCartProduct {
	
	@Resource(name="propertiesService") protected EgovPropertyService propertiesService;
	@Resource(name="batchManagerService") private BatchManagerService batchManagerService;
    @Resource(name="batchCartProductService") private BatchCartProductService batchCartProductService;
	...
	public void CartProduct() throws Exception{
		...
		*/
		...
		commandMap.put("BCH_MST_ID", Code.BATCH_CODE_DELETE_CART_PRODUCT); 	// 배치 아이디 	- 장바구니만료삭제:08
		commandMap.put("BCH_MST_NM", Code.BATCH_NAME_DELETE_CART_PRODUCT); // 배치 명 		- [관리] 장바구니만료삭제
        ...
        if( totalCount == 0 ){	        
	    	...
	    	try{
	    		// 배치작업.
	    		resultMap = this.batchCartProductService.deleteCartProduct(commandMap);
	    		json.put("resultYn","Y");

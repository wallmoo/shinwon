 ...
 */
@Component
public class BatchEpNaverBrief {
	
	@Resource(name="propertiesService") protected EgovPropertyService propertiesService;
	@Resource(name="batchManagerService") private BatchManagerService batchManagerService;
    @Resource(name="naverEPService") private NaverEPService naverEPService;
    ...
    //@Scheduled(cron="0 */1 * * * *")
    //@Scheduled(cron="0 40 7-21 * * *")	//실제설정
	public void BatchEpNaverBrief() throws Exception{
        logger.info("===============================");
		// 서버IP 확인
...
//		}
		...
		commandMap.put("BCH_MST_ID", Code.BATCH_CODE_EP_BRIEF_NAVER); 	// 배치 아이디 	- "58"
		commandMap.put("BCH_MST_NM", Code.BATCH_NAME_EP_BRIEF_NAVER); 	// 배치 명 		- [관리] 네이버 EP 데이터 변경분 생성
...
//	    		this.batchWeatherApiService.insertWeather();
	    		naverEPService.makeNaverBriefProductEP();
	    		json.put("resultYn","Y");

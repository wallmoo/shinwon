package com.market.mall.ifcomm.sms;
		...
		try {
			...
			if(smsSendYn.equals("Y")){
				...
				if("0".equals(smsMap.get("resultCode"))){
					...
					int tr_num = defaultDAO.insert("Sms.insertMMS", smsMap);
		...
		try {
			...
			if(smsSendYn.equals("Y")){
				...
				if("0".equals(smsMap.get("resultCode"))){
					...
					int tr_num = defaultDAO.insert("Sms.insertLmsMsg", smsMap);//LMS 전송
								 defaultDAO.insert("Sms.insertLmsHistory", smsMap);//LMS 전송

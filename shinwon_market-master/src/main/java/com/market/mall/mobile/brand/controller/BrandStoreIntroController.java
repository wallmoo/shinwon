 ...
 * @Date : 2015. 7. 17.
 * @프로그램 설명 : 사용자 > 모바일 > 브랜드사이트 > 매장안내 관련하여 처리하는 Controller Class
 * @author DEV_KIMSOYOUNG
 */

@Controller("mobileBrandStoreIntroController")
public class BrandStoreIntroController 
{
	...
	* @throws Exception
	*/
	@RequestMapping("/mobile/brand/brandStoreIntroMarmot")
	public ModelAndView brandStoreIntroMarmot (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
        ...
        // 해당 브랜드로 이동
        mv.setViewName("mobile/brand/brandStoreIntroMarmot");
	...
	* @throws Exception
	*/
	@RequestMapping("/mobile/brand/brandStoreAddrInfo")
	public ModelAndView brandAddrPopup (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
		...
		// 해당 브랜드로 이동
        mv.setViewName("mobile/brand/brandStoreAddrInfo");
	...
	* @throws Exception
	*/
	@RequestMapping("/mobile/brand/brandStoreIntroMountia")
	public ModelAndView brandStoreIntroMountia (HttpServletRequest request, @RequestParams Map<String,Object> commandMap) throws Exception
	{
        ...
        // 해당 브랜드로 이동
        mv.setViewName("mobile/brand/brandStoreIntroMountia");

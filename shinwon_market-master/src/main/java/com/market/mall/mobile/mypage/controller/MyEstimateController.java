...
@Controller("mMyEstimateController")
public class MyEstimateController {
	 ...
	 * 3. Comment : 모바일 > MY LAND > 쇼핑활동 > MY 견적 
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 4. 7.
	 * </pre>
	 *
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mobile/mypage/myEstimate")
	public ModelAndView myEstimate(HttpServletRequest request, @RequestParams() Map<String, Object> commandMap) throws Exception{
		...
		User user = SessionsUser.getSessionUser(request);
      	...
      	if(SessionsUser.isLogin(request) ){
			...
			mv.setViewName("mobile/mypage/myEstimate");
		}else{
	 ...
	 * 2. ClassName : MyEstimateController.java
	 * 3. Comment : 모바일 > MY LAND > 쇼핑활동 > MY 견적 > 상세
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 4. 7.
	 * </pre>
	 *
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mobile/mypage/myEstimateDetail")
	public ModelAndView myEstimateDetail(HttpServletRequest request, @RequestParams() Map<String, Object> commandMap) throws Exception{ 
		...
		if(SessionsUser.isLogin(request) ){
			...
			if(user.getMEM_MST_MEM_ID().equals(info.get("ESM_MST_MEM_ID")) && info.size() > 0){
				...
				mv.addObject("commandMap", commandMap);
				mv.setViewName("mobile/mypage/myEstimateDetail");
	 ...
	 * 2. ClassName : MyEstimateController.java
	 * 3. Comment : 모바일 > MY LAND > 쇼핑활동 > MY 견적 > 댓글 등록  
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 4. 8.
	 * </pre>
	 *
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mobile/mypage/myEstimateCommentReqAjax")
	 ...
	 * 2. ClassName : MyEstimateController.java
	 * 3. Comment : 모바일 > MY LAND > 쇼핑활동 > MY 견적 > 댓글 리스트
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 4. 8.
	 * </pre>
	 *
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mobile/mypage/myEstimateCommentListAjax")
	 ...
	 * 2. ClassName : MyEstimateController.java
	 * 3. Comment : 모바일 > MY LAND > 쇼핑활동 > MY 견적 > 구매 확정 
	 * 4. 작성자 : Lee
	 * 5. 작성일 : 2016. 4. 8.
	 * </pre>
	 *
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mobile/mypage/myEstimateChoiceAjax")

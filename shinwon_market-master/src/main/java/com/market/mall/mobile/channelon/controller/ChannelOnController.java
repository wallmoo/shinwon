package com.market.mall.mobile.channelon.controller;
...
@Controller("mobileChannelOnController")
public class ChannelOnController {
	...
	/**
	 * @api {POST} /mobile/channelon/channelonList.do 
	 * @apiName 채널온 메인화면
	 * @apiGroup Mobile 채널온
	 * 
	 ...
	 */
	@RequestMapping("/mobile/channelon/channelonList")
    ...
    /**
     * @api {POST} /mobile/channelon/channelonListAjax.do
     * @apiName 채널온 목록  ajax
     * @apiGroup Mobile 채널온
     *
     * @apiParam {Integer} cPage 현재 페이지
     ...
     */
    @RequestMapping("/mobile/channelon/channelonListAjax")
    ...
    /**
     * @api {POST} /mobile/channelon/channelonView.do
     * @apiName 채널온 상세화면
     * @apiGroup Mobile 채널온
     * 
     ...
     */
    @RequestMapping("/mobile/channelon/channelonView")
    ...
    /**
     * @api {POST} /mobile/channelon/channelonProductAjax.do  
     ...
     * @apiParam {String} CNT_MST_IDX 채널온 idx
     * 
     * @apiSuccess {Object[]} channelOnProductList 채널온 상품 목록 [{"CNT_PRD_COLOR":[{"CNT_PRD_COLOR":"#b8860b","CMN_COM_NM":"노란색(임시)"},{"CNT_PRD_COLOR":"#f4a460","CMN_COM_NM":"빨간색(임시)"},{"CNT_PRD_COLOR":"#faf080","CMN_COM_NM":"라임색(임시)"}],"PRD_MST_SEL_CNT":1,"IMG_THUMBNAIL_BIG":"/mobile/img/second/NoImage_250.jpg","PRD_MST_DSP_PRC":110000000,"REP_STAR":0,"CNT_DTL_ORDER":0,"RNK":1,"LIKE_COUNT":1,"RNK_NUM":1,"IMG_THUMBNAIL":"/mobile/img/second/NoImage_250.jpg","REP_POINT_GRD":"00","REP_CNT":0,"RNK_GB":"a","REP_POINT":"00","PRD_MST_PRC":110000000,"PRD_MST_NM_SUB":"[올리브영] 수발이랑놀자","PRD_MST_SEL_STATE":"T","PRD_MST_CNL_PC_YN":"Y","PRD_MST_NM":"수발이랑놀자","RNUM":1,"PRD_SALE_RATE":0,"CNT_GRP_IDX":14,"MY_LIKE":"N","CNT_PRD_MST_CD":"S0011953","PRD_MST_BRAND_NM":"올리브영","PRD_MST_CNL_MB_YN":"N","CNT_PRD_PRICE":110000000,"PRD_MST_ICON_LIST":"<span class=\"ico_coupon\"><span class=\"ir\">쿠폰할인<\/span><\/span> ;"},{"CNT_PRD_COLOR":[{"CNT_PRD_COLOR":"#facf0e","CMN_COM_NM":"오렌지색(임시)"},{"CNT_PRD_COLOR":"#d3d3d3","CMN_COM_NM":"검정색(임시)"},{"CNT_PRD_COLOR":"#f4a460","CMN_COM_NM":"빨간색(임시)"}],"PRD_MST_SEL_CNT":222,"IMG_THUMBNAIL_BIG":"/mobile/img/second/NoImage_250.jpg","PRD_MST_DSP_PRC":1000000,"REP_STAR":0,"CNT_DTL_ORDER":0,"RNK":2,"LIKE_COUNT":0,"RNK_NUM":2,"IMG_THUMBNAIL":"/mobile/img/second/NoImage_250.jpg","REP_POINT_GRD":"00","REP_CNT":0,"RNK_GB":"b","REP_POINT":"00","PRD_MST_PRC":1000000,"PRD_MST_NM_SUB":"[올리브영] 패키지 테스트1","PRD_MST_SEL_STATE":"I","PRD_MST_CNL_PC_YN":"Y","PRD_MST_NM":"패키지 테스트1","RNUM":3,"PRD_SALE_RATE":0,"CNT_GRP_IDX":14,"MY_LIKE":"N","CNT_PRD_MST_CD":"S0011951","PRD_MST_BRAND_NM":"올리브영","PRD_MST_CNL_MB_YN":"Y","CNT_PRD_PRICE":1000000},{"CNT_PRD_COLOR":[{"CNT_PRD_COLOR":"#f4a460","CMN_COM_NM":"빨간색(임시)"},{"CNT_PRD_COLOR":"#ffffff","CMN_COM_NM":"하얀색(임시)"},{"CNT_PRD_COLOR":"#f4a460","CMN_COM_NM":"빨간색(임시)"}],"PRD_MST_SEL_CNT":22222,"IMG_THUMBNAIL_BIG":"/mobile/img/second/NoImage_250.jpg","PRD_MST_DSP_PRC":99999999,"REP_STAR":0,"CNT_DTL_ORDER":0,"RNK":3,"LIKE_COUNT":0,"RNK_NUM":3,"IMG_THUMBNAIL":"/mobile/img/second/NoImage_250.jpg","REP_POINT_GRD":"00","REP_CNT":0,"RNK_GB":"a","REP_POINT":"00","PRD_MST_PRC":99999999,"PRD_MST_NM_SUB":"[올리브영] 묶음상품 테스트 1","PRD_MST_SEL_STATE":"O","PRD_MST_CNL_PC_YN":"Y","PRD_MST_NM":"묶음상품 테스트 1","RNUM":2,"PRD_SALE_RATE":0,"CNT_GRP_IDX":14,"MY_LIKE":"N","CNT_PRD_MST_CD":"S0011952","PRD_MST_BRAND_NM":"올리브영","PRD_MST_CNL_MB_YN":"N","CNT_PRD_PRICE":99999999}]}
     */
    @RequestMapping("/mobile/channelon/channelonProductAjax")
    public JSON channelonProductAjax (HttpServletRequest request, @RequestParams Map<String, Object> commandMap) throws Exception{
        ...
        List<Map<String, Object>> channelOnProductList = null;
        if(totalCount > 0){
            // 채널온 상품 목록
            channelOnProductList = this.pcChannelOnService.selectChannelOnProductList(commandMap);
        }
        json.put("totalCount", StringUtil.getString(totalCount));
        json.put("channelOnProductList", channelOnProductList);

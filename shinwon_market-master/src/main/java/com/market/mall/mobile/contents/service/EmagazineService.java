package com.market.mall.mobile.contents.service;
...
public interface EmagazineService {

	/**
	 * 
	 * <pre>
	 * 1. MethodName : getPcEmagazineIngInfo
	 * 2. ClassName : EmagazineService.java
	 * 3. Comment : 이매거진 > 이매거진 메인  
	 * 4. 작성자 : KhCho
	 * 5. 작성일 : 2016. 1. 13.
	 * </pre>
	 *
	 ...
	 * 
	 * <pre>
	 * 1. MethodName : selectEmagazineCtgName
	 * 2. ClassName : EmagazineService.java
	 * 3. Comment : 이매거진 > 이매거진 카테고리명 조회
	 * 4. 작성자 : KhCho
	 * 5. 작성일 : 2016. 1. 13.
	 * </pre>
	 *
	 ...
	 * 
	 * <pre>
	 * 1. MethodName : selectMobileEmagazineProductList
	 * 2. ClassName : EmagazineService.java
	 * 3. Comment : 이매거진 > 이매거진 상품리스트(모바일)
	 * 4. 작성자 : KhCho
	 * 5. 작성일 : 2016. 1. 20.
	 * </pre>
	 *

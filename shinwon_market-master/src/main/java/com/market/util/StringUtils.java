...
//          str = str.replaceAll("#"  , "&#35;");
    ...
    public static char getRandomUpperCaseCharactor() {
    	String alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"; 
    	Random random = new Random();
    	return alphabet.charAt(random.nextInt(alphabet.length()));
    }
    public static String[] getSplitedPhoneNumber(String phoneNumber) {
    	String[] splitedPhoneNumber = new String[]{ "", "", ""};
    	if(phoneNumber == null || phoneNumber.isEmpty()) return splitedPhoneNumber;
    	splitedPhoneNumber[0] =  phoneNumber.substring(0, 3);
    	if(phoneNumber.length()==11) {
    		splitedPhoneNumber[1] =  phoneNumber.substring(3, 7);	
    	}
    	else {
    		splitedPhoneNumber[1] =  phoneNumber.substring(3, 6);
    	}
    	splitedPhoneNumber[2] =  phoneNumber.substring(phoneNumber.length()-4, phoneNumber.length());
		return splitedPhoneNumber;
	}
    public static void getSplitedPhoneNumberTest(String[] args) {
    	String[] testCast = getSplitedPhoneNumber("0117644512");
    	System.out.println("T1");
    	System.out.println(testCast[0]);
    	System.out.println(testCast[1]);
    	System.out.println(testCast[2]);
    	System.out.println();
    	testCast = getSplitedPhoneNumber("01096070502");
    	System.out.println("T2");
    	System.out.println(testCast[0]);
    	System.out.println(testCast[1]);
    	System.out.println(testCast[2]);
    	System.out.println();
    	testCast = getSplitedPhoneNumber("0194434567");
